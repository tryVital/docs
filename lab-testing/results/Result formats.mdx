...
Vital's API returns results in a number of different formats. Current formats we support are:
...
We also return the parsed results in JSON format, so you can use the results to to produce/generate your own forms.
