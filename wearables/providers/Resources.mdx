...
For example, `Workouts` is made up of fields specific to an workout, like calories, distance and duration. When you make a request to `summary/<user_id>/workouts` you get the following fields:
