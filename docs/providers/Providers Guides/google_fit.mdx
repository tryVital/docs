...
Activity data fetched from Google Fit, in particular step count data, might be slightly different than the readings in the Google Fit app. This can happen for a variety of reasons:
