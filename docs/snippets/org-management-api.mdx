<Info>
The [Junction Management API](/api-details/junction-management-api) is available for [the Scale plan](https://tryvital.io/pricing).
</Info>
...
A Team API Key is not accepted.
</Tip>
