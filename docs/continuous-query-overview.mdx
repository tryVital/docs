...
<Accordion title="Health Monitoring & Reporting">
  ...
  **Example: Daily Sleep Analysis**
  ...
  - [View example →](/sense/examples#daily-main-sleep-session-analysis)
...
<Accordion title="Continuous Glucose Monitoring">
  ...
  **Example: Daily Summaries of Metabolites**
  ...
  - [View example →](/sense/examples#daily-aggregations-of-select-timeseries-datapoints-grouped-by-source-type-and-provider)
</Accordion>
...
<Accordion title="Fitness & Performance Tracking">
  ...
  **Example: Weekly Workout Statistics**
  ...
  - [View example →](/sense/examples#weekly-insights-into-workout-statistics)
