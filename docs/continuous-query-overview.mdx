...
Most resources use the same Query DSL with both products, making it easy to prototype with Query API and deploy to production with Continuous Query. Some virtual resources, including [Device Reliability](/sense/query-dsl/device-reliability), are only available through Continuous Query and cannot be accessed with Query API. 
