...
<Steps>
    ...
    If you have trouble with data availability in general, the [User Resource Introspection](https://docs.tryvital.io/api-reference/data/introspection/user-resources) endpoint
