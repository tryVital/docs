...
description: "Contact Junction support via email or Slack, and learn what information to include when reporting issues for faster resolution."
---
...
* Email Support (help@junction.com)
...
<Steps>
    ...
    If you are having issues with historical data specifically, the [Historical Pull Introspection](https://docs.tryvital.io/api-reference/data/introspection/historical-pulls) endpoint
    ...
    If you have troubles with data availability in general, the [User Resource Introspection](https://docs.tryvital.io/api-reference/data/introspection/user-resources) endpoint
