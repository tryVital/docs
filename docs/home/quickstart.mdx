...
To create a team and get your API keys, you first need to sign up for a Vital account in the [Dashboard](https://app.junction.com).
...
>
  ...
  accounts with Vital. It allows you to access their accounts via the Junction API.
</Card>
