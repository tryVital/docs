...
Vital Link is a client-side component your users will interact with in order to link their accounts with Vital and allow you to access their accounts via the Vital API.
