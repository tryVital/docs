...
<CodeBlock title={"Generating a Vital-Link"} include_client_instantiation={true}>
...
<CodeBlock title={"Connecting a password provider:"} include_client_instantiation={true}>
