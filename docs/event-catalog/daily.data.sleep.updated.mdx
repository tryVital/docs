...
<Expandable title="ClientFacingSleep">
...
<ResponseField name="score" type="integer" required="false">
...
<ResponseField name="sleep_stream" type="ClientFacingSleepStream" required="false">
<Expandable title="ClientFacingSleepStream">
<ResponseField name="hrv" type="ClientFacingHRVTimeseries[]" required="false">
...
<ResponseField name="heartrate" type="ClientFacingHeartRateTimeseries[]" required="false">
...
<ResponseField name="hypnogram" type="ClientFacingHypnogramTimeseries[]" required="false">
...
<ResponseField name="respiratory_rate" type="ClientFacingRespiratoryRateTimeseries[]" required="false">
...
```json Example
{
  ...
  "data": {
    "id": "78491876-b299-4314-95dd-aca629c99684",
    "date": "2023-05-20T15:09:47.560122+00:00",
    "calendar_date": "2023-05-20",
    "bedtime_start": "2023-05-20T15:09:47.560139+00:00",
    "bedtime_stop": "2023-05-20T15:09:47.560142+00:00",
    ...
    "user_id": "36f4f884-4ed1-4b03-af27-a04d0925147b"
  }
}
```
</ResponseExample> 
