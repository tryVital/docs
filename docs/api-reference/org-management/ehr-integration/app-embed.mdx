...
* Configure your App Embed integration through ["Org Config → EHR Integration"](https://app.junction.com/org/ehr-integration) in the [Junction Dashboard](https://app.junction.com), or programmatically with the [Get Configuration](/api-reference/org-management/ehr-integration/get-configuration) and [Upsert Configuration](/api-reference/org-management/ehr-integration/upsert-configuration) endpoints.
