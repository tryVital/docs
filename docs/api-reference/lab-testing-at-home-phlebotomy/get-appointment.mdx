---
openapi: "GET /v3/order/{order_id}/phlebotomy/appointment"
---
...
data = client.AtHomePhlebotomy.get_appointment(order_id="413d7205-f8a9-42ed-aa4a-edb99e481ca0")
```
...
const data = await client.AtHomePhlebotomy.getAppointment("413d7205-f8a9-42ed-aa4a-edb99e481ca0");
```
