---
openapi: "PATCH /v3/order/{order_id}/phlebotomy/appointment/reschedule"
---
...
data = client.AtHomePhlebotomy.reschedule_appointment(
...
const data = await client.AtHomePhlebotomy.rescheduleAppointment(
