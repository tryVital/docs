---
title: "Update appointment cancel"
description: "Partially update order phlebotomy appointment cancel via the Junction API. Requires authentication with your team API key."
...
const data = await client.labTests.cancelPhlebotomyAppointment("<order_id>", request);
```
...
var data = vital.labTests().cancelPhlebotomyAppointment("<order_id>", request);
```
...
response, err := client.LabTests.CancelPhlebotomyAppointment(context.TODO(), "<order_id>", request)
if err != nil {
    return err
}
