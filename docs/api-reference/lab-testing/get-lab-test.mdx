---
title: "Get Lab Test"
description: "Retrieve details about a specific lab test, including included markers and collection methods."
...
data = client.lab_tests.get_by_id(lab_test_id="<lab_test_id>")
```
...
const data = await client.labTests.getById(labTestId);
```
...
var data = vital.labTests().getById(labTestId);
```
...
response, err := client.LabTests.GetById(context.TODO(), labTestId)
if err != nil {
    return err
}
