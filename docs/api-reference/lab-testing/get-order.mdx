---
title: "Get order"
description: "Retrieve order via the Junction API. Requires authentication with your team API key."
...
response, err := client.LabTests.GetOrder(context.TODO(), "<order_id>")
if err != nil {
  return err
}
