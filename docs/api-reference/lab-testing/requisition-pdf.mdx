...
const data = await client.labTests.getOrderRequisitionPdf("<order_id>");
```
...
var data = vital.labTests().getOrderRequisitionPdf("<order_id>");
```
...
response, err := client.LabTests.GetOrderRequisitionPdf(context.TODO(), "<order_id>")
if err != nil {
  return err
}
