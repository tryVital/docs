...
## Group by any Table Column or Source Column expression
...
| Argument                          | Remarks
| --------------------------------- | ---------------
| timeseries / \<summary\>          | The data column to group by. This can be any of the [Timeseries](/api-reference/horizon-ai/aggregation/query-dsl/column-expressions#timeseries%3A) or [Summary](/api-reference/horizon-ai/aggregation/query-dsl/column-expressions#summaries%3A) columns.
