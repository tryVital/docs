...
## Group by any atrribute from the table expression

Group the input rows based on a resource specific attribute or a shared source attribute.
...
| Argument                          | Remarks
| --------------------------------- | ---------------
| source / timeseries / \<summary\>   | The input table expression to group by.
