...
| Workout ID                            | `Source.col("source_workout_id")`    | `{ "source": "source_workout_id"}` | available in a few timeseries resource eg. `workout_distance` or `workout_swimming_stroke`
| Sport                                 | `Source.col("source_sport")`         | `{ "source": "source_sport" }`     | available in a few timeseries resource eg. `workout_distance` or `workout_swimming_stroke`
