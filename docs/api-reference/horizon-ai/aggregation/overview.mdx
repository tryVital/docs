---
title: "Horizon AI Query Overview"
description: "Learn how Horizon AI Query consolidates wearable data across providers into simple tabular outputs."
---
...
Horizon AI Query consolidates the multitude of user data collected across [wearable data providers](/wearables/providers/introduction)
...
You can use Horizon AI Query through two mediums:
