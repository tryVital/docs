...
### Decision Guide
<Steps>
<Step title="Experiment with Aggregation API">
    Start with Aggregation API if you need quick insights, one-time analysis or query experimentation using an individual user's data.
</Step>
...
Choose based on your current needs — rapid analysis and iteration with Aggregation API or continual data monitoring with Continuous Query. Both features use the same Query DSL, complement each other and can adapt as your product evolves.
