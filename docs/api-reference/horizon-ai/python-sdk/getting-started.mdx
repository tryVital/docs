...
Sign-in locally on your machine with your [Vital Dashboard](https://app.tryvital.io/) account. You can
...
Call the `auth login` CLI subcommand on the `vitalx-cli` package.
...
<Step title="Sign in with your Vital Dashboard account">
You would be prompted in your default web browser to sign-in to the [Vital Dashboard](https://app.tryvital.io/).
