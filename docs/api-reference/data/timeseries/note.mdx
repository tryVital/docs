---
title: "Note"
description: "Retrieve grouped health notes timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve note time-series entries for a user across a date range from connected health data providers."
---
