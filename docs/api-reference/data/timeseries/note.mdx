---
title: "Note"
description: "Retrieve user-logged note timeseries data attached to health and wearable events for a specific user."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve user health notes timeseries data for a user, grouped by source, over a specified date range."
---
