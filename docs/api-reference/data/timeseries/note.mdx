---
title: "Note"
description: "Reference for the Vital timeseries API endpoint that returns user-logged text notes for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve grouped user note timeseries data for a user across a specified date range."
---
