---
title: "Note"
description: "Retrieve grouped user-recorded note time series entries for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve user-authored note time series entries for a user over a specified date range."
---
