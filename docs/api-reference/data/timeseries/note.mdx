---
title: "Note"
description: "Retrieve a user's note time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve note time series data for a specific user over a given date range, grouped by data source."
---
