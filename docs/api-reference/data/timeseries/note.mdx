---
title: "Note"
description: "Retrieve user-recorded note time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve time series user-recorded notes attached to health data for a Vital user across a date range."
