---
title: "Note"
description: "Retrieve free-form health notes recorded by a specific user across their connected health sources."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve symptom and health notes logged by the user for a user as a time series across supported wearables and devices."
---
