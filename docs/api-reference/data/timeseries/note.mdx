---
title: "Note"
description: "Retrieve grouped user-entered note time-series data for a user across a specified date range from connected health apps and manual entries."
