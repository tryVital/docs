---
title: "Note"
description: "Fetch grouped time-series data for user-recorded notes attached to health data for a Junction user, returned by source provider over a date range."
