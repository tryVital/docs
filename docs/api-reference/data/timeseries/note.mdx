---
title: "Note"
description: "Retrieve user-logged notes and annotations for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve grouped user-recorded health notes timeseries data for a user across a date range from the Vital API."
---
