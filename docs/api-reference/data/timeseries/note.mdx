---
title: "Note"
description: "Retrieve time-series notes data for a specific user, returning free-form notes logged against the user's health data within a given date range."
