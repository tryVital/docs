---
title: "Note"
description: "Retrieve a user's note timeseries entries, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve note time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
