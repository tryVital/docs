---
title: "Note"
description: "Retrieve grouped timeseries data for user health notes and annotations from connected health apps."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve grouped time-series note data for a user over a specified date range."
---
