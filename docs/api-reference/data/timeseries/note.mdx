---
title: "Note"
description: Retrieve user-recorded note time-series entries for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve free-form note timeseries entries logged by a user across connected health sources."
---
