---
title: "Note"
description: "Retrieve time series user notes attached to health data for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Query a user's note time series data through the Junction API, sourced from their connected wearables and health providers."
---
