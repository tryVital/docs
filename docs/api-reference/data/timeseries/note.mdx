---
title: "Note"
description: "Retrieve grouped user-recorded note time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/note/grouped"
description: "Retrieve grouped user-recorded note time-series data for a user across a specified date range."
---
