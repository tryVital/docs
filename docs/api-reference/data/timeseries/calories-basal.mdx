...
description: "Retrieve basal calories burned through resting metabolic activity for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve grouped basal (resting) calories burned timeseries data for a user across a date range from the Vital API."
---
