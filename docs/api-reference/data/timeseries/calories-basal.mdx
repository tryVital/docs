...
description: "Retrieve grouped basal calories burned timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve basal (resting) calories burned time-series data for a user across a date range from connected wearables and providers."
---
