...
description: "Retrieve a user's basal calories burned timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve calories basal time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
