...
description: "Retrieve basal calories burned at rest (resting metabolic rate) for a specific user from a connected wearable."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve basal energy burned at rest by the user for a user as a time series across supported wearables and devices."
---
