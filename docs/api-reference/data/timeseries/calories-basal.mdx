...
description: Retrieve basal calorie expenditure time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve basal calories burned timeseries data representing a user's resting energy expenditure."
---
