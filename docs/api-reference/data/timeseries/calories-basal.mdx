...
description: "Retrieve grouped timeseries data for basal metabolic calorie expenditure from a user's connected wearable."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve grouped basal calories timeseries data for a user over a specified date range."
---
