...
description: "Retrieve time series basal (resting) calories burned measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Query a user's basal calories burned time series data through the Junction API, sourced from their connected wearables and health providers."
---
