...
description: "Retrieve grouped timeseries data for basal metabolic rate calories from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve grouped time-series basal calories data for a user over a specified date range."
---
