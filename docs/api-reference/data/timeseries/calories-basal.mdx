...
description: "Retrieve a user's calories basal time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve calories basal time series data for a specific user over a given date range, grouped by data source."
---
