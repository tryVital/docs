...
description: "Reference for the Vital timeseries API endpoint that returns basal (resting) calories burned for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve grouped basal calories burned timeseries data for a user across a specified date range."
---
