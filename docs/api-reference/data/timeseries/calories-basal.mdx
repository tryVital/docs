...
description: "Retrieve time-series basal calories data for a specific user, returning basal (resting) calories burned by the user within a given date range."
