...
description: "Retrieve grouped basal (resting) calories burned time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve grouped basal calories burned time-series data for a user across a specified date range."
---
