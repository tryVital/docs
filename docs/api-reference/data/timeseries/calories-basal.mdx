...
description: "Retrieve basal calorie burn time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve time series basal calories burned at rest for a Vital user across a date range."
