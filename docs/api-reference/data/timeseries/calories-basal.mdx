...
description: "Retrieve grouped basal (resting) calories burned time-series data for a user across a specified date range from connected wearables and apps."
