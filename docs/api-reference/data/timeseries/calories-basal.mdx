...
description: "Retrieve basal (resting) calories burned timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/calories_basal/grouped"
description: "Retrieve basal calories burned timeseries data for a user, grouped by source, over a specified date range."
---
