...
description: "Retrieve grouped respiratory rate time-series data for a user across a specified date range from connected wearables and sleep tracking devices."
