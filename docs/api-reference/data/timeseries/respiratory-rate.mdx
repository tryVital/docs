...
description: Retrieve respiratory rate time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve respiratory rate timeseries data captured from a user's connected wearable or device."
---
