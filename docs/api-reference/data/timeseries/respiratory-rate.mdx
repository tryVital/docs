...
description: "Retrieve grouped respiratory rate time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve grouped respiratory rate time-series data for a user across a specified date range."
---
