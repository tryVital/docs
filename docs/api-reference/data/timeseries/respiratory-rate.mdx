...
description: "Retrieve grouped respiratory rate timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve respiratory rate time-series data for a user across a date range from connected wearables and health data providers."
---
