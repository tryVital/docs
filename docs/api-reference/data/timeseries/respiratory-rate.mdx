...
description: "Retrieve respiratory rate time series (breaths per minute) for a specific user from a connected wearable."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve respiratory rate readings from supported wearables for a user as a time series across supported wearables and devices."
---
