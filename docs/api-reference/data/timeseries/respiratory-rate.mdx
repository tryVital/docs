...
description: "Retrieve respiratory rate measurements in breaths per minute for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve grouped respiratory rate timeseries data for a user across a date range from the Vital API."
---
