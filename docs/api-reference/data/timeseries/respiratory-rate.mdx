...
description: "Retrieve respiratory rate timeseries data for a user from their connected wearable device, in breaths per minute."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve respiratory rate timeseries data for a user, grouped by source, over a specified date range."
---
