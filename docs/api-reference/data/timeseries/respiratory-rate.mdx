...
description: "Retrieve grouped respiratory rate time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve respiratory rate time series data for a user over a specified date range."
---
