...
description: "Retrieve a user's respiratory rate time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve respiratory rate time series data for a specific user over a given date range, grouped by data source."
---
