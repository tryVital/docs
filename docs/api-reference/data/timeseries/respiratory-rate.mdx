...
description: "Retrieve respiratory rate timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Query respiratory rate time series data for a user over a date range, grouped by provider source, with the Junction API."
---
