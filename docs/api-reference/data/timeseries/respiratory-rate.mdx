...
description: "Retrieve time series respiratory rate measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Query a user's respiratory rate time series data through the Junction API, sourced from their connected wearables and health providers."
---
