...
description: "Reference for the Vital timeseries API endpoint that returns respiratory rate readings in breaths per minute for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve grouped respiratory rate timeseries data for a user across a specified date range."
---
