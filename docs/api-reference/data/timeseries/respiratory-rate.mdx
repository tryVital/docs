...
description: "Retrieve grouped timeseries data for respiratory rate measurements from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/respiratory_rate/grouped"
description: "Retrieve grouped time-series respiratory rate data for a user over a specified date range."
---
