...
description: "Reference for the Vital timeseries API endpoint that returns peak expiratory flow rate (PEFR) spirometry readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve grouped peak expiratory flow rate timeseries data for a user across a specified date range."
---
