...
description: "Retrieve grouped peak expiratory flow rate timeseries data for a user across a specified date range from connected wearables and providers."
