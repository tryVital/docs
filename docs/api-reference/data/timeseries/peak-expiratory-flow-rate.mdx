...
description: "Retrieve a user's peak expiratory flow rate time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate time series data for a specific user over a given date range, grouped by data source."
---
