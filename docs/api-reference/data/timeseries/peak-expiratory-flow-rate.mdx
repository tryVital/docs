...
description: "Retrieve grouped timeseries data for peak expiratory flow rate (PEFR) from connected spirometer devices."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve grouped time-series peak expiratory flow rate data for a user over a specified date range."
---
