...
description: "Query a user's peak expiratory flow rate time series data through the Vital API, sourced from their connected wearables and health providers."
---
