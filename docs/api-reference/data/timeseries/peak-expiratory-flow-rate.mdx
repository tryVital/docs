...
description: "Retrieve a user's peak expiratory flow rate timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
