...
description: "Retrieve grouped peak expiratory flow rate time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve grouped peak expiratory flow rate time-series data for a user across a specified date range."
---
