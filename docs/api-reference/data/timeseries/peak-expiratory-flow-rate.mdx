...
description: "API endpoint to retrieve a user's peak expiratory flow rate time series data, grouped by source, from their connected wearables and health data providers."
