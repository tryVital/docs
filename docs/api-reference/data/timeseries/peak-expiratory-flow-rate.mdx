...
description: "Fetch grouped time-series data for peak expiratory flow rate (PEFR) measurements for a Junction user, returned by source provider over a date range."
