...
description: "Retrieve grouped peak expiratory flow rate time series measurements for a user across a date range."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate time series data for a user over a specified date range."
---
