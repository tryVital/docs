...
description: "Retrieve peak expiratory flow rate timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Query peak expiratory flow rate time series data for a user over a date range, grouped by provider source, with the Junction API."
---
