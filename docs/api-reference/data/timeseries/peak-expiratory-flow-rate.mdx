...
description: "Retrieve peak expiratory flow rate timeseries data for a user from their connected spirometry device."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate (PEFR) timeseries data for a user, grouped by source, over a specified date range."
---
