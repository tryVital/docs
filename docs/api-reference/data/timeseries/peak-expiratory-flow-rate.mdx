...
description: Retrieve peak expiratory flow rate (PEFR) spirometry time-series readings for a user, grouped by source provider.
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate timeseries data from a user's spirometry measurements."
---
