...
description: "Retrieve time series peak expiratory flow rate (PEFR) measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Query a user's peak expiratory flow rate time series data through the Junction API, sourced from their connected wearables and health providers."
---
