...
description: "Retrieve grouped peak expiratory flow rate timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate time-series data for a user across a date range from connected respiratory devices."
---
