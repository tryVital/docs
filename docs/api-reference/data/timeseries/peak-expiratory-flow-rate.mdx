...
description: "Retrieve peak expiratory flow rate (PEF) time series data for a specific user from connected sources."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve peak expiratory flow rate (PEFR) spirometry readings for a user as a time series across supported wearables and devices."
---
