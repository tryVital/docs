...
description: "Retrieve peak expiratory flow rate measurements from spirometry for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve grouped peak expiratory flow rate (PEFR) timeseries data for a user across a date range from the Vital API."
---
