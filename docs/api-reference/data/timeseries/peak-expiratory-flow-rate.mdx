...
description: "Retrieve grouped peak expiratory flow rate (PEFR) time-series data for a user across a specified date range from connected spirometry devices."
