...
description: "Retrieve time-series peak expiratory flow rate data for a specific user, returning peak expiratory flow rate (PEFR) spirometry values within a given date range."
