...
description: "Retrieve peak expiratory flow rate time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/peak_expiratory_flow_rate/grouped"
description: "Retrieve time series peak expiratory flow rate spirometry readings for a Vital user across a date range."
