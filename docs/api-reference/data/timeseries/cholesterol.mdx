---
title: "Cholesterol"
description: "Retrieve grouped cholesterol timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol time-series data for a user across a date range from connected health data providers and lab sources."
---
