---
title: "Cholesterol"
description: "Retrieve cholesterol measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve grouped cholesterol measurements timeseries data for a user across a date range from the Vital API."
---
