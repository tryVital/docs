---
title: "Cholesterol"
description: Retrieve cholesterol time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol timeseries data captured from a user's connected lab or device sources."
---
