---
title: "Cholesterol"
description: "Retrieve cholesterol time series measurements for a specific user from their connected health data source."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol measurements recorded for the user for a user as a time series across supported wearables and devices."
---
