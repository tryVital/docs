---
title: "Cholesterol"
description: "Retrieve cholesterol timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Query cholesterol time series data for a user over a date range, grouped by provider source, with the Junction API."
---
