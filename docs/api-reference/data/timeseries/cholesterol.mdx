---
title: "Cholesterol"
description: "Retrieve a user's cholesterol timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
