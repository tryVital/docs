---
title: "Cholesterol"
description: "Retrieve cholesterol timeseries data for a user, recorded through their connected health app or device."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol levels timeseries data for a user, grouped by source, over a specified date range."
---
