---
title: "Cholesterol"
description: "Retrieve grouped cholesterol time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol measurement time series data for a user over a specified date range."
---
