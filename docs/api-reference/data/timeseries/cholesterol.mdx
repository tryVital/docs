---
title: "Cholesterol"
description: "Retrieve grouped cholesterol time-series data logged for a user across a specified date range from connected health apps and manual entries."
