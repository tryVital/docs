---
title: "Cholesterol"
description: "Retrieve grouped cholesterol time-series data for a user across connected wearable, lab, and health data providers."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve grouped cholesterol time-series data for a user across a specified date range."
---
