---
title: "Cholesterol"
description: "Reference for the Vital timeseries API endpoint that returns cholesterol readings from connected devices and lab sources for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve grouped cholesterol timeseries data for a user across a specified date range."
---
