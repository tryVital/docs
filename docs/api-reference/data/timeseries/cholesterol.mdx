---
title: "Cholesterol"
description: "Retrieve grouped timeseries data for cholesterol level measurements from connected health devices."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve grouped time-series cholesterol data for a user over a specified date range."
---
