---
title: "Cholesterol"
description: "Retrieve grouped timeseries data for cholesterol level measurements from a user's connected health provider."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve grouped cholesterol level timeseries data for a user over a specified date range."
---
