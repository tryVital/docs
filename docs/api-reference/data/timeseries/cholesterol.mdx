---
title: "Cholesterol"
description: "Retrieve a user's cholesterol time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/cholesterol/grouped"
description: "Retrieve cholesterol time series data for a specific user over a given date range, grouped by data source."
---
