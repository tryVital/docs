---
title: "Ige"
description: "Retrieve Immunoglobulin E (IgE) measurements from lab results for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve grouped Immunoglobulin E (IgE) lab measurements timeseries data for a user across a date range from the Vital API."
---
