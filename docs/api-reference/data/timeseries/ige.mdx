---
title: "Ige"
description: "Retrieve grouped immunoglobulin E (IgE) timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve immunoglobulin E (IgE) time-series data for a user across a date range from connected lab and health data providers."
---
