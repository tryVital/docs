---
title: "Ige"
description: "Retrieve grouped timeseries data for immunoglobulin E (IgE) measurements from connected health devices."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve grouped time-series IgE data for a user over a specified date range."
---
