---
title: "Ige"
description: "Retrieve immunoglobulin E (IgE) lab result timeseries data for a user from their connected health records."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve immunoglobulin E (IgE) levels timeseries data for a user, grouped by source, over a specified date range."
---
