---
title: "Ige"
description: "Retrieve grouped immunoglobulin E (IgE) time series lab measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve immunoglobulin E (IgE) measurement time series data for a user over a specified date range."
---
