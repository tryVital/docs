---
title: "Ige"
description: Retrieve immunoglobulin E (IgE) time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve immunoglobulin E (IgE) timeseries data captured from a user's connected lab sources."
---
