---
title: "IgE"
description: "Retrieve a user's immunoglobulin E (IgE) timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve immunoglobulin E (IgE) time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
