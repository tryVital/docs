---
title: "Ige"
description: "Retrieve immunoglobulin E (IgE) lab measurement time series for a specific user from connected health data sources."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve immunoglobulin E (IgE) lab measurements for the user for a user as a time series across supported wearables and devices."
---
