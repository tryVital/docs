---
title: "Ige"
description: "Reference for the Vital timeseries API endpoint that returns immunoglobulin E (IgE) antibody results for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve grouped immunoglobulin E (IgE) timeseries data for a user across a specified date range."
---
