---
title: "Ige"
description: "Retrieve grouped immunoglobulin E (IgE) time-series data for a user across connected lab and health data providers."
openapi: "GET /v2/timeseries/{user_id}/ige/grouped"
description: "Retrieve grouped immunoglobulin E (IgE) time-series data for a user across a specified date range."
---
