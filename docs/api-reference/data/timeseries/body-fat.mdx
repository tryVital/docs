---
title: "Body Fat"
description: "Retrieve a user's body fat percentage time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve body fat time series data for a specific user over a given date range, grouped by data source."
---
