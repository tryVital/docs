---
title: "Body Fat"
description: "Retrieve grouped body fat percentage timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve body fat percentage time-series data for a user across a date range from connected scales and health data providers."
---
