---
title: "Body Fat"
description: "Reference for the Vital timeseries API endpoint that returns body fat percentage readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve grouped body fat percentage timeseries data for a user across a specified date range."
---
