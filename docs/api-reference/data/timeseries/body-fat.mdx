---
title: "Body Fat"
description: "Retrieve time series body fat percentage measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Query a user's body fat percentage time series data through the Junction API, sourced from their connected wearables and health providers."
---
