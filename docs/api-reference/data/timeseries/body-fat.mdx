---
title: "Body Fat"
description: "Retrieve body fat percentage timeseries data for a user from their connected smart scale or wearable device."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve body fat percentage timeseries data for a user, grouped by source, over a specified date range."
---
