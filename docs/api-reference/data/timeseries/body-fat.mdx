---
title: "Body Fat"
description: "Retrieve grouped body fat percentage time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve grouped body fat percentage time-series data for a user across a specified date range."
---
