---
title: "Body Fat"
description: "Retrieve grouped body fat percentage time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve body fat percentage time series data for a user over a specified date range."
---
