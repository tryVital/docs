---
title: "Body Fat"
description: "Retrieve body fat percentage time series data for a specific user from their connected wearable or smart scale."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve body fat percentage measurements recorded for a user across supported wearables and devices."
---
