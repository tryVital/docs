---
title: "Body Fat"
description: Retrieve body fat percentage time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve body fat percentage timeseries data measured from a user's connected smart scale or device."
---
