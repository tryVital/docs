---
title: "Body Fat"
description: "Retrieve body fat percentage measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve grouped body fat percentage timeseries data for a user across a date range from the Vital API."
---
