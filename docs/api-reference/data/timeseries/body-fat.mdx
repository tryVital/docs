---
title: "Body Fat"
description: "Retrieve body fat timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Query body fat time series data for a user over a date range, grouped by provider source, with the Junction API."
---
