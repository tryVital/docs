---
title: "Body Fat"
description: "Retrieve grouped timeseries data for body fat percentage measurements from connected scales and wearables."
openapi: "GET /v2/timeseries/{user_id}/body_fat/grouped"
description: "Retrieve grouped time-series body fat data for a user over a specified date range."
---
