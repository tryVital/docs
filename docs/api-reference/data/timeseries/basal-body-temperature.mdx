...
description: Retrieve basal body temperature time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve basal body temperature timeseries data captured at rest for menstrual cycle tracking."
---
