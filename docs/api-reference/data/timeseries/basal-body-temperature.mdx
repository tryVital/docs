...
description: "Retrieve grouped timeseries data for basal body temperature readings from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve grouped time-series basal body temperature data for a user over a specified date range."
---
