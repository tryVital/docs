...
description: "Reference for the Vital timeseries API endpoint that returns basal body temperature readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve grouped basal body temperature timeseries data for a user across a specified date range."
---
