...
description: "Retrieve basal body temperature measurements taken at rest for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve grouped basal body temperature timeseries data for a user across a date range from the Vital API."
---
