...
description: "Retrieve basal body temperature timeseries data for a user, recorded by their connected wearable or health app."
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve basal body temperature timeseries data for a user, grouped by source, over a specified date range."
---
