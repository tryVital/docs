...
description: "Retrieve grouped basal body temperature time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve basal body temperature time series data for a user over a specified date range."
---
