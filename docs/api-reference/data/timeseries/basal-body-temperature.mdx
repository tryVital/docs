...
description: "Retrieve grouped basal body temperature time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/basal_body_temperature/grouped"
description: "Retrieve grouped basal body temperature time-series data for a user across a specified date range."
---
