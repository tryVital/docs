...
description: "Retrieve basal (resting) body temperature readings for a Junction user across a date range, grouped by source provider, via the timeseries API."
