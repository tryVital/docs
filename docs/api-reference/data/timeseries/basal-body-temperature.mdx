...
description: "Retrieve grouped basal body temperature time series data for a user, containing resting body temperature measurements from connected sources."
