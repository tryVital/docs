...
description: "Query a user's sleep breathing disturbance time series data through the Vital API, sourced from their connected wearables and health providers."
---
