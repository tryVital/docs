...
description: "Retrieve breathing disturbances detected during sleep for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve grouped sleep breathing disturbance events timeseries data for a user across a date range from the Vital API."
---
