...
description: "Retrieve sleep breathing disturbance timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve sleep breathing disturbance timeseries data for a user, grouped by source, over a specified date range."
---
