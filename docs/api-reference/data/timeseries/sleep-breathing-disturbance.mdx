...
description: "Retrieve grouped sleep breathing disturbance time series data for a user, containing breathing disturbances detected during sleep from connected sources."
