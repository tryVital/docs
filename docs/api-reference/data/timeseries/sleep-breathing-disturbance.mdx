...
description: "Retrieve grouped sleep breathing disturbance time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve grouped sleep breathing disturbance time-series data for a user across a specified date range."
---
