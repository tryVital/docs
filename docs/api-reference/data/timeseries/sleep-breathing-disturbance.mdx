...
description: "Retrieve time series sleep breathing disturbance measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Query a user's sleep breathing disturbance time series data through the Junction API, sourced from their connected wearables and health providers."
---
