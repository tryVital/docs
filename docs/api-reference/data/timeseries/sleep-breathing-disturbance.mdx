...
description: "Retrieve sleep breathing disturbance time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve time series breathing disturbances detected during sleep for a Vital user across a date range."
