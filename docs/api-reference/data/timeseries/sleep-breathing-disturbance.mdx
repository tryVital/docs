...
description: "API endpoint to retrieve a user's sleep breathing disturbance time series data, grouped by source, from their connected wearables and health data providers."
