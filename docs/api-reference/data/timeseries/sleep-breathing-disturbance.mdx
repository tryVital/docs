...
description: Retrieve sleep breathing disturbance time-series data for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve sleep breathing disturbance timeseries data detected by a user's wearable during sleep."
---
