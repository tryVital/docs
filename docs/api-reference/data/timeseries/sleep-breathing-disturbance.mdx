...
description: "Retrieve sleep breathing disturbance timeseries data for a specific user, grouped by source across connected wearables and health providers."
