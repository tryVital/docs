...
description: "Retrieve grouped sleep breathing disturbance time series events for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve sleep breathing disturbance time series data for a user over a specified date range."
---
