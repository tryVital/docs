...
description: "Reference for the Vital timeseries API endpoint that returns breathing disturbances detected during sleep for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve grouped sleep breathing disturbance timeseries data for a user across a specified date range."
---
