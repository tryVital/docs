...
description: "Retrieve a user's sleep breathing disturbance time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve sleep breathing disturbance time series data for a specific user over a given date range, grouped by data source."
---
