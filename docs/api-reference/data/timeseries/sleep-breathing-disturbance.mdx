...
description: "Retrieve grouped timeseries data for sleep breathing disturbance measurements from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve grouped time-series sleep breathing disturbance data for a user over a specified date range."
---
