...
description: "Retrieve grouped sleep breathing disturbance timeseries data for a user across a specified date range from connected wearables and providers."
