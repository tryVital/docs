...
description: "Retrieve grouped sleep breathing disturbances timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve sleep breathing disturbance time-series data for a user across a date range from connected wearables and sleep trackers."
---
