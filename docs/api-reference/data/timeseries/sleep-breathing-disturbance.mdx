...
description: "Retrieve sleep breathing disturbance events for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve breathing disturbance levels detected during sleep for a user as a time series across supported wearables and devices."
---
