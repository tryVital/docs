...
description: "Retrieve a user's sleep breathing disturbance timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/sleep_breathing_disturbance/grouped"
description: "Retrieve sleep breathing disturbance time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
