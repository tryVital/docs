---
title: "Fall"
description: Retrieve detected fall events as time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall detection event timeseries data recorded by a user's connected wearable device."
---
