---
title: "Fall"
description: "Retrieve grouped timeseries data for fall detection events from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve grouped time-series fall detection data for a user over a specified date range."
---
