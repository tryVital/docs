---
title: "Fall"
description: "Retrieve grouped fall detection time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve grouped fall detection time-series data for a user across a specified date range."
---
