---
title: "Fall"
description: "Retrieve grouped fall detection timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall event time-series data for a user across a date range from connected wearables and health data providers."
---
