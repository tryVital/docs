---
title: "Fall"
description: "Retrieve a user's fall detection timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
