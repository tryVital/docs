---
title: "Fall"
description: "Retrieve time series fall detection events for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Query a user's fall detection time series data through the Junction API, sourced from their connected wearables and health providers."
---
