---
title: "Fall"
description: "Reference for the Vital timeseries API endpoint that returns detected fall events for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve grouped fall detection timeseries data for a user across a specified date range."
---
