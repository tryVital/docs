---
title: "Fall"
description: "Retrieve grouped fall detection event time-series data for a user across a specified date range from connected wearables and health devices."
