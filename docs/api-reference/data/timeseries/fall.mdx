---
title: "Fall"
description: "Retrieve a user's fall time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall time series data for a specific user over a given date range, grouped by data source."
---
