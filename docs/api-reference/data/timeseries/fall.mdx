---
title: "Fall"
description: "Retrieve time-series fall data for a specific user, returning fall detection events recorded by the user's device within a given date range."
