---
title: "Fall"
description: "Retrieve fall detection event time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve time series detected fall events for a Vital user across a date range."
