---
title: "Fall"
description: "Retrieve grouped fall detection time series events recorded for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall detection event time series data for a user over a specified date range."
---
