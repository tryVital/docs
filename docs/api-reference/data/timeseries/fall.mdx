---
title: "Fall"
description: "Retrieve fall detection event timeseries data for a user, recorded by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall detection events timeseries data for a user, grouped by source, over a specified date range."
---
