---
title: "Fall"
description: "Retrieve fall detection events for a specific user as recorded by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve fall detection events captured by the user’s wearable for a user as a time series across supported wearables and devices."
---
