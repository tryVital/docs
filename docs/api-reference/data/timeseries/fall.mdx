---
title: "Fall"
description: "Retrieve fall detection events reported by the wearable device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/fall/grouped"
description: "Retrieve grouped fall detection events timeseries data for a user across a date range from the Vital API."
---
