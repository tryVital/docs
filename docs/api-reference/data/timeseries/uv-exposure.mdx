---
title: "Uv Exposure"
description: Retrieve UV exposure time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve ultraviolet (UV) exposure timeseries data captured from a user's connected wearable device."
---
