---
title: "Uv Exposure"
description: "Retrieve grouped timeseries data for ultraviolet (UV) light exposure from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve grouped time-series UV exposure data for a user over a specified date range."
---
