---
title: "Uv Exposure"
description: "Retrieve ultraviolet (UV) exposure timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve UV exposure timeseries data for a user, grouped by source, over a specified date range."
---
