---
title: "Uv Exposure"
description: "Retrieve a user's UV exposure time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve UV exposure time series data for a specific user over a given date range, grouped by data source."
---
