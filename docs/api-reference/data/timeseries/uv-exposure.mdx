---
title: "Uv Exposure"
description: "Retrieve grouped ultraviolet (UV) exposure time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve UV exposure time series data for a user over a specified date range."
---
