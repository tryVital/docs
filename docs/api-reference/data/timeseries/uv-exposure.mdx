---
title: "Uv Exposure"
description: "Retrieve UV exposure timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Query UV exposure time series data for a user over a date range, grouped by provider source, with the Junction API."
---
