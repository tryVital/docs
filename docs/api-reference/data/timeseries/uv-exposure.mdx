---
title: "Uv Exposure"
description: "Retrieve UV exposure time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve time series ultraviolet (UV) light exposure for a Vital user across a date range."
