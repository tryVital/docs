---
title: "Uv Exposure"
description: "Retrieve ultraviolet (UV) exposure measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve grouped UV exposure timeseries data for a user across a date range from the Vital API."
---
