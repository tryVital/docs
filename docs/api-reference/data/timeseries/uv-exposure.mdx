---
title: "Uv Exposure"
description: "Reference for the Vital timeseries API endpoint that returns ultraviolet (UV) light exposure for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve grouped UV exposure timeseries data for a user across a specified date range."
---
