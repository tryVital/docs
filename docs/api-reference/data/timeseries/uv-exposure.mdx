---
title: "Uv Exposure"
description: "Retrieve time series ultraviolet (UV) exposure measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Query a user's UV exposure time series data through the Junction API, sourced from their connected wearables and health providers."
---
