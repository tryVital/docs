---
title: "Uv Exposure"
description: "Retrieve grouped UV exposure timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve UV exposure time-series data for a user across a date range from connected wearables and health data providers."
---
