---
title: "Uv Exposure"
description: "Retrieve grouped ultraviolet (UV) exposure time-series data for a user across a specified date range from connected wearables and health apps."
