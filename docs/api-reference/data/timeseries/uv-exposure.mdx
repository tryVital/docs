---
title: "Uv Exposure"
description: "Retrieve UV exposure time series data for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/uv_exposure/grouped"
description: "Retrieve ultraviolet (UV) light exposure measured for the user for a user as a time series across supported wearables and devices."
---
