---
title: "Uv Exposure"
description: "Fetch grouped time-series data for ultraviolet (UV) light exposure measurements for a Junction user, returned by source provider over a date range."
