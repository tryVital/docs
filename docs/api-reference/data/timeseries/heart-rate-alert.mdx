...
description: "Retrieve high and low heart rate alerts triggered by the wearable device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve grouped heart rate alert events timeseries data for a user across a date range from the Vital API."
---
