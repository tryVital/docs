...
description: "Retrieve high and low heart rate alert events for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve high and low heart rate alerts triggered by the user’s wearable for a user as a time series across supported wearables and devices."
---
