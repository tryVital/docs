...
description: "Reference for the Vital timeseries API endpoint that returns high and low heart rate alerts for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve grouped heart rate alert timeseries data for a user across a specified date range."
---
