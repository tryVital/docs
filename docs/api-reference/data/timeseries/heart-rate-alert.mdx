...
description: "Fetch grouped time-series data for heart rate alert notifications for high or low values for a Junction user, returned by source provider over a date range."
