...
description: "Retrieve time-series heart rate alerts data for a specific user, returning abnormal heart rate alerts triggered on the user's device within a given date range."
