...
description: "Retrieve grouped heart rate alert time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve grouped heart rate alert time-series data for a user across a specified date range."
---
