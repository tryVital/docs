...
description: "Retrieve heart rate alert timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Query heart rate alert time series data for a user over a date range, grouped by provider source, with the Junction API."
---
