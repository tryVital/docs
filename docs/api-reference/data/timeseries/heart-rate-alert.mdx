...
description: "Retrieve heart rate alert event timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve heart rate alerts timeseries data for a user, grouped by source, over a specified date range."
---
