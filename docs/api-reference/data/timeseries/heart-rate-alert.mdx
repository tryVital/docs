...
description: "Retrieve grouped timeseries data for heart rate alert events from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve grouped time-series heart rate alert data for a user over a specified date range."
---
