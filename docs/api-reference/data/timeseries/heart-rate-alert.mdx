...
description: "Retrieve grouped heart rate alerts timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve heart rate alert time-series data for a user across a date range from connected wearables and health providers."
---
