...
description: Retrieve heart-rate alert events as time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Retrieve heart rate alert events flagged by a user's wearable for high or low heart rate."
---
