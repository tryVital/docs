...
description: "Retrieve time series high and low heart rate alerts for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/heart_rate_alert/grouped"
description: "Query a user's heart rate alert time series data through the Junction API, sourced from their connected wearables and health providers."
---
