...
description: "Retrieve grouped systolic and diastolic blood pressure time series data for a user across a date range from the Vital API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-30T15:53:03+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
