...
description: "Retrieve time series systolic and diastolic blood pressure measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Query a user's blood pressure time series data through the Junction API, sourced from their connected wearables and health providers."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-15T10:32:01+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
