...
description: "Retrieve blood pressure timeseries data for a user, including systolic and diastolic readings from connected devices."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve blood pressure timeseries data for a user, grouped by source, over a specified date range."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-09T12:57:20+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
