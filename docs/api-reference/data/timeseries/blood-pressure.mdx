...
description: "Retrieve blood pressure timeseries data for a user, grouped by source provider, within a specified date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-23T13:26:48+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
