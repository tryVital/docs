...
description: Retrieve systolic and diastolic blood pressure time-series readings for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve systolic and diastolic blood pressure timeseries data from a user's connected device."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-05-29T10:03:33+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
