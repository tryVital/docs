...
description: "Reference for the Vital timeseries API endpoint that returns systolic and diastolic blood pressure readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve grouped blood pressure timeseries data for a user across a specified date range."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-07-21T10:06:56+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
