...
description: "Retrieve blood pressure time series data for a user over a specified date range, grouped by source provider."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-21T17:14:52+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
