...
description: "Retrieve blood pressure timeseries data for a user, grouped by source provider, between the specified start and end dates."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-23T10:23:04+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
