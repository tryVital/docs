...
description: "Retrieve grouped systolic and diastolic blood pressure time series readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve systolic and diastolic blood pressure time series data for a user over a specified date range."
---
