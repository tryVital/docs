...
description: "Fetch a user's grouped blood pressure time-series data from their connected wearables, health devices, and provider sources."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-24T22:31:54+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
