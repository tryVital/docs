...
description: "Retrieve blood pressure timeseries data for a user via the Junction API. Requires authentication with your team API key."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-09T15:39:27+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
