...
description: "Retrieve blood pressure readings for a Junction user across a date range, grouped by source provider, via the timeseries API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-05-27T09:25:45+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
