...
description: "Retrieve blood pressure time-series data for a user, grouped by source provider, across a given date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-28T11:33:19+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
