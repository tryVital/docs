...
description: "Retrieve blood pressure timeseries data for a user across connected providers within a specified date range using the Vital API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-05-01T18:06:10+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
