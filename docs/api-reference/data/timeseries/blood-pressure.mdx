...
description: "Retrieve grouped systolic and diastolic blood pressure time-series data for a user across connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve grouped blood pressure time-series data for a user across a specified date range."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-12T13:17:07+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
