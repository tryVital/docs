...
description: "Retrieve blood pressure readings for a specific user, including systolic and diastolic values from connected sources."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve systolic and diastolic blood pressure readings for a user as a time series across supported wearables and devices."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-05-19T18:29:18+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
