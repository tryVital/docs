...
description: "Retrieve a user's systolic and diastolic blood pressure readings, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve blood pressure time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-28T16:17:52+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
