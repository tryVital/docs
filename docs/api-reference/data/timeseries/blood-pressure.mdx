...
description: "Retrieve a user's blood pressure time series data, grouped by source, from connected providers with the Junction API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-02T18:30:09+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
