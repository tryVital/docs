...
description: "Retrieve grouped blood pressure timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve systolic and diastolic blood pressure time-series data for a user across a date range from connected devices and providers."
---
