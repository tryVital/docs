...
description: "Retrieve blood pressure time series data for a user via the Junction API. Requires authentication with your team API key."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-27T23:30:20+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
