...
description: "Retrieve a user's blood pressure time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve blood pressure time series data for a specific user over a given date range, grouped by data source."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-27T16:10:21+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
