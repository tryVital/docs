...
description: "Retrieve blood pressure timeseries data for a user from connected wearables and health apps via the Vital API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-24T14:22:12+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
