...
description: "Retrieve time series blood pressure readings (systolic and diastolic) for a specific user, grouped by the connected wearable provider."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-22T19:39:33+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
