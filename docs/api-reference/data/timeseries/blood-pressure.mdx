...
description: "Retrieve grouped systolic and diastolic blood pressure time-series data for a user over a given date range from the Vital API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-23T18:47:33+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
