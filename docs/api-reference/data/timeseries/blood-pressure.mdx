...
description: "Retrieve systolic and diastolic blood pressure time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve time series systolic and diastolic blood pressure readings for a Vital user across a date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-14T15:56:28+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
