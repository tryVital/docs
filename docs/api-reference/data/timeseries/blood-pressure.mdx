...
description: "Retrieve blood pressure time-series data for a user across a specified date range from all connected providers."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-23T12:46:08+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
