...
description: "Retrieve a user's systolic and diastolic blood pressure readings over a given date range from the Vital timeseries API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-07-20T13:07:39+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
