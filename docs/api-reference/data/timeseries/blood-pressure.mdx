...
description: "Retrieve blood pressure timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Query blood pressure time series data for a user over a date range, grouped by provider source, with the Junction API."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-01T16:00:42+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
