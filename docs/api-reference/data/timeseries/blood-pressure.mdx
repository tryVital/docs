...
description: "API reference for retrieving grouped blood pressure timeseries data for a user over a specified date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-08T15:42:01+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
