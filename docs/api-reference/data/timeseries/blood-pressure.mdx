...
description: "Retrieve grouped blood pressure time series for a Vital user across a specified date range from the Vital API."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-22T14:21:30+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
