...
description: "API reference for retrieving grouped blood pressure timeseries data for a user from connected health devices."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-03-27T17:00:20+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
