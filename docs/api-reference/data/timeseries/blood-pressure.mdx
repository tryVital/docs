...
description: "Retrieve blood pressure time-series data for a user over a date range, grouped by source, from Vital's Data API."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-07T08:36:23+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
