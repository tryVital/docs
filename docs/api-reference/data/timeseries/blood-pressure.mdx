...
description: "Retrieve grouped timeseries data for systolic and diastolic blood pressure readings from connected devices."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve grouped time-series blood pressure data for a user over a specified date range."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-21T11:20:39+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
