...
description: "Retrieve blood pressure timeseries data for a user from their connected wearable devices and health data sources via the Junction API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-05-13T13:39:11+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
