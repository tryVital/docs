...
description: "Retrieve systolic and diastolic blood pressure timeseries readings for a user, grouped by source provider, via the Junction API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-27T16:41:53+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
