...
description: "Retrieve blood pressure time series data for a user, grouped by data source, from wearables and health providers connected through Junction."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-26T11:33:59+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
