...
description: "Retrieve blood pressure time series data recorded for a user, grouped by source, through the Junction API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-25T14:29:22+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
