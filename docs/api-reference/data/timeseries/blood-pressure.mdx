...
description: "Fetch grouped time-series data for blood pressure readings (systolic and diastolic) for a Junction user, returned by source provider over a date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-05-04T11:27:01+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
