...
description: "Retrieve grouped timeseries data for blood pressure readings from a user's connected wearable or blood pressure monitor."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve grouped blood pressure timeseries data for a user over a specified date range."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-03-30T13:22:12+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
