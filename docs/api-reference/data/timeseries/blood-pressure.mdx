...
description: "Retrieve timeseries blood pressure grouped via the Junction API. Requires authentication with your team API key."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-03-24T17:50:07+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
