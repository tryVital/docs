...
description: "Fetch grouped blood pressure time-series data for a user across a specified date range from the Vital API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-23T09:33:48+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
