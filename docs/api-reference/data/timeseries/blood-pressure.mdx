...
description: "API reference for querying a user's blood pressure timeseries data, grouped by source, over a date range with the Junction API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-28T09:37:56+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
