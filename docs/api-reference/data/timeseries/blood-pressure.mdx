...
description: "Retrieve systolic and diastolic blood pressure readings for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/blood_pressure/grouped"
description: "Retrieve grouped systolic and diastolic blood pressure timeseries data for a user across a date range from the Vital API."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-19T12:35:49+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
