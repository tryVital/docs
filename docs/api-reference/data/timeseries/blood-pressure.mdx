...
description: "Retrieve blood pressure timeseries data for a Vital user, grouped by source provider across a given date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-08-18T07:47:22+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
