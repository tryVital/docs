...
description: "API endpoint to retrieve a user's blood pressure time series data, grouped by source, from their connected wearables and health data providers."
