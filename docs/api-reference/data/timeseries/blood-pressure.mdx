...
description: "Retrieve grouped blood pressure time-series data for a user from the Vital API, including measurements and source metadata."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-03T14:06:41+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
