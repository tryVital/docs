...
description: "Fetch systolic and diastolic blood pressure time-series samples for a user, grouped by provider over a date range."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-14T23:04:27+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
