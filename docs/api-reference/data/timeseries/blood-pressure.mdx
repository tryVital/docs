...
description: "Retrieve grouped blood pressure time series data for a user over a specified date range from connected wearable providers."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-04-23T12:45:29+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
