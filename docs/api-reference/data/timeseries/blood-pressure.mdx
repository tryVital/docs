...
description: "Retrieve systolic and diastolic blood pressure readings for a specific user via the Vital timeseries API."
---
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-06-09T19:35:55+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
