...
description: "Query a user's blood pressure time series data over a date range, grouped by data source, using the Junction API."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-09T09:11:10+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
