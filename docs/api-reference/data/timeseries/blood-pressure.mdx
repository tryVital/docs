...
description: "Retrieve blood pressure timeseries data for a user via the Junction API, grouped by provider or lab source."
        ...
        "data": [
          {
            "diastolic": 75,
            "systolic": 125,
            "timestamp": "2026-09-25T11:57:23+00:00",
            "unit": "mmHg"
          }
        ],
        "source": {
