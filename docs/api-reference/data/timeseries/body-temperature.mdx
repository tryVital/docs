...
description: "Retrieve body temperature timeseries data for a user from their connected wearable or health app."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve body temperature timeseries data for a user, grouped by source, over a specified date range."
---
