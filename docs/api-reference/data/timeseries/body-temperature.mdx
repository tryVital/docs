...
description: "Retrieve body temperature measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve grouped body temperature timeseries data for a user across a date range from the Vital API."
---
