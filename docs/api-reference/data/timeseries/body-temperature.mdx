...
description: "Reference for the Vital timeseries API endpoint that returns body temperature readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve grouped body temperature timeseries data for a user across a specified date range."
---
