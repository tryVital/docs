...
description: "Retrieve core body temperature time series data for a specific user from their connected wearable or health source."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve core body temperature readings recorded by the user for a user as a time series across supported wearables and devices."
---
