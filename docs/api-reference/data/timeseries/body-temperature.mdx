...
description: "Retrieve time series body temperature measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Query a user's body temperature time series data through the Junction API, sourced from their connected wearables and health providers."
---
