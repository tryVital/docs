...
description: "Retrieve a user's body temperature time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve body temperature time series data for a specific user over a given date range, grouped by data source."
---
