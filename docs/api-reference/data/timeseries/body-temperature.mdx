...
description: "Retrieve grouped body temperature timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve body temperature time-series data for a user across a date range from connected wearables and health data providers."
---
