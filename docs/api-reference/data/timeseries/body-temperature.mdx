...
description: "Retrieve grouped timeseries data for body temperature readings from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve grouped time-series body temperature data for a user over a specified date range."
---
