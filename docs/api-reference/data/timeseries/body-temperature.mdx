...
description: "Retrieve grouped body temperature time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/body_temperature/grouped"
description: "Retrieve grouped body temperature time-series data for a user across a specified date range."
---
