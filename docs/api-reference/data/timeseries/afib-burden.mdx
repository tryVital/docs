---
title: "Afib Burden"
description: "Retrieve grouped atrial fibrillation burden time series data for a user over a specified date range."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve atrial fibrillation burden time series data for a user over a specified date range."
---
