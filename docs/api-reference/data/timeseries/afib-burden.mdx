---
title: "Afib Burden"
description: "Retrieve grouped atrial fibrillation burden time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve grouped atrial fibrillation burden time-series data for a user across a specified date range."
---
