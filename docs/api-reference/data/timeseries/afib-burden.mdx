---
title: "Afib Burden"
description: "Retrieve a user's atrial fibrillation (AFib) burden timeseries data, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve AFib burden time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
