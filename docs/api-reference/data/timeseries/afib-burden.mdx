---
title: "Afib Burden"
description: Retrieve atrial fibrillation (AFib) burden time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve atrial fibrillation burden timeseries data, showing the percentage of time a user's heart was in AFib."
---
