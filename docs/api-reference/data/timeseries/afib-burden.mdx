---
title: "Afib Burden"
description: "Reference for the Vital timeseries API endpoint that returns atrial fibrillation burden percentages for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve grouped atrial fibrillation (AFib) burden timeseries data for a user across a specified date range."
---
