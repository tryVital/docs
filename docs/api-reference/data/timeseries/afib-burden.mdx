---
title: "Afib Burden"
description: "Retrieve atrial fibrillation burden timeseries data for a user, measured by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve atrial fibrillation burden timeseries data for a user, grouped by source, over a specified date range."
---
