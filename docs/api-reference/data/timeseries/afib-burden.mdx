---
title: "Afib Burden"
description: "Retrieve time series atrial fibrillation (AFib) burden measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Query a user's AFib burden time series data through the Junction API, sourced from their connected wearables and health providers."
---
