---
title: "Afib Burden"
description: "Retrieve atrial fibrillation burden time-series data for a user, showing the percentage of time spent in AFib from connected wearable devices."
