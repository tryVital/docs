---
title: "Afib Burden"
description: "Retrieve grouped atrial fibrillation (AFib) burden time series data for a Vital user across their connected wearable and health data sources."
