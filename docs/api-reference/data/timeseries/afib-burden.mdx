---
title: "Afib Burden"
description: "Retrieve grouped atrial fibrillation burden timeseries data for a user across a specified date range from connected wearables and providers."
