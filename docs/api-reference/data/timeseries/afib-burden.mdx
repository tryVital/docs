---
title: "Afib Burden"
description: "Retrieve the percentage of time the heart shows signs of atrial fibrillation for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve grouped atrial fibrillation burden timeseries data for a user across a date range from the Vital API."
---
