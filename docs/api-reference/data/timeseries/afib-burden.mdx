---
title: "Afib Burden"
description: "Retrieve a user's AFib burden time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve AFib burden time series data for a specific user over a given date range, grouped by data source."
---
