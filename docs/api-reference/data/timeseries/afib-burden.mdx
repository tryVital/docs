---
title: "Afib Burden"
description: "Retrieve grouped atrial fibrillation burden time series data for a user, containing the estimated percentage of time in AFib from connected sources."
