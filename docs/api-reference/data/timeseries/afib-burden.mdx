---
title: "Afib Burden"
description: "Retrieve atrial fibrillation burden time series for a user, showing the percentage of time the heart is in AFib."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve daily atrial fibrillation burden measurements from supported wearables for a user as a time series across supported wearables and devices."
---
