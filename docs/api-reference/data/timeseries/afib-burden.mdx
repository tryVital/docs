---
title: "Afib Burden"
description: "Fetch a user's grouped atrial fibrillation (AFib) burden time-series data from their connected wearables, health devices, and provider sources."
