---
title: "Afib Burden"
description: "Retrieve atrial fibrillation burden time series for a user, showing the percentage of time the heart was in AFib over each measurement window."
