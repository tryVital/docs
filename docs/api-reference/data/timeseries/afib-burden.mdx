---
title: "Afib Burden"
description: "Retrieve AFib burden timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Query AFib burden time series data for a user over a date range, grouped by provider source, with the Junction API."
---
