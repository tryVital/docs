---
title: "Afib Burden"
description: "Retrieve atrial fibrillation burden time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve time series atrial fibrillation burden, the percentage of time spent in AFib for a Vital user across a date range."
