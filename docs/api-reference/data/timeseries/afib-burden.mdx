---
title: "Afib Burden"
description: "Retrieve atrial fibrillation (AFib) burden timeseries data for a user across connected providers within a specified date range using the Vital API."
