---
title: "Afib Burden"
description: "Retrieve grouped atrial fibrillation burden timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/afib_burden/grouped"
description: "Retrieve atrial fibrillation burden time-series data for a user across a date range, aggregated from connected wearables and health providers."
---
