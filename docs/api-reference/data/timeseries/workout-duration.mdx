...
description: "Retrieve grouped workout duration time series data for a user, containing total time spent in each workout session across connected sources."
