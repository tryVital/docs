...
description: "Retrieve the duration of a workout session for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve grouped per-workout duration timeseries data for a user across a date range from the Vital API."
---
