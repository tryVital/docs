...
description: "Retrieve grouped timeseries data for workout duration measurements from connected fitness trackers and apps."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve grouped time-series workout duration data for a user over a specified date range."
---
