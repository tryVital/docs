...
description: "Retrieve a user's workout duration time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve workout duration time series data for a specific user over a given date range, grouped by data source."
---
