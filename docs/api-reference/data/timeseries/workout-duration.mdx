...
description: "Retrieve time series workout duration measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Query a user's workout duration time series data through the Junction API, sourced from their connected wearables and health providers."
---
