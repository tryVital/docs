...
description: "Retrieve workout duration timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Query workout duration time series data for a user over a date range, grouped by provider source, with the Junction API."
---
