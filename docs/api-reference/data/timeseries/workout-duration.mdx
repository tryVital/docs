...
description: "Retrieve grouped workout duration timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve workout duration time-series data for a user across a date range from connected wearables and fitness providers."
---
