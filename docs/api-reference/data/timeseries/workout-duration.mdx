...
description: "Retrieve workout duration timeseries data for a user from their connected wearable or fitness app."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve workout duration timeseries data for a user, grouped by source, over a specified date range."
---
