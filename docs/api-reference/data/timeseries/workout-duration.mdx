...
description: "Retrieve grouped workout duration time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve per-workout duration time series data for a user over a specified date range."
---
