...
description: Retrieve workout-duration time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve per-workout duration timeseries data captured from a user's connected wearable device."
---
