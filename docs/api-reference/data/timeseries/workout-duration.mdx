...
description: "Reference for the Vital timeseries API endpoint that returns duration streams recorded during workouts for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve grouped workout duration timeseries data for a user across a specified date range."
---
