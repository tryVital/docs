...
description: "Retrieve grouped per-workout duration time-series data for a user across a specified date range from connected wearables and fitness trackers."
