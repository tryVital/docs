...
description: "Retrieve grouped per-workout duration time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve grouped workout duration time-series data for a user across a specified date range."
---
