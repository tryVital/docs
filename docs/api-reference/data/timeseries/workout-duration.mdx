...
description: "Retrieve workout duration time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve time series duration of workout sessions for a Vital user across a date range."
