...
description: "Retrieve workout duration time series data for a specific user from their connected fitness provider."
openapi: "GET /v2/timeseries/{user_id}/workout_duration/grouped"
description: "Retrieve duration time series captured during a workout for a user as a time series across supported wearables and devices."
---
