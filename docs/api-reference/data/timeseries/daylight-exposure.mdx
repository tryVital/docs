...
description: "Retrieve time series daylight exposure measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Query a user's daylight exposure time series data through the Junction API, sourced from their connected wearables and health providers."
---
