...
description: "Retrieve grouped daylight exposure time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve grouped daylight exposure time-series data for a user across a specified date range."
---
