...
description: "Retrieve daylight exposure time series data for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve time the user has spent exposed to daylight for a user as a time series across supported wearables and devices."
---
