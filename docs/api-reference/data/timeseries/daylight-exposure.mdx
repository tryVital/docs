...
description: "API endpoint to retrieve a user's daylight exposure time series data, grouped by source, from their connected wearables and health data providers."
