...
description: "Retrieve a user's daylight exposure timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve daylight exposure time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
