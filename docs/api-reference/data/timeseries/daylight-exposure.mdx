...
description: "Retrieve grouped daylight exposure time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve daylight exposure time series data for a user over a specified date range."
---
