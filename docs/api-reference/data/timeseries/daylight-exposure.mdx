...
description: "Retrieve time-series daylight exposure data for a specific user, returning time the user spent exposed to daylight within a given date range."
