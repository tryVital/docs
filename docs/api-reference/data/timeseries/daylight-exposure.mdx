...
description: "Retrieve time spent exposed to daylight for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve grouped time spent in daylight timeseries data for a user across a date range from the Vital API."
---
