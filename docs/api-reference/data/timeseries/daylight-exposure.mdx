...
description: "Retrieve grouped timeseries data for daylight exposure duration from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve grouped time-series daylight exposure data for a user over a specified date range."
---
