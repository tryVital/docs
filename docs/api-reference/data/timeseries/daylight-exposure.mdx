...
description: "Retrieve daylight exposure time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve time series time spent exposed to daylight for a Vital user across a date range."
