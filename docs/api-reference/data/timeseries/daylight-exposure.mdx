...
description: "Retrieve daylight exposure timeseries data for a user, measured by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve daylight exposure timeseries data for a user, grouped by source, over a specified date range."
---
