...
description: "Reference for the Vital timeseries API endpoint that returns time spent in daylight for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve grouped daylight exposure timeseries data for a user across a specified date range."
---
