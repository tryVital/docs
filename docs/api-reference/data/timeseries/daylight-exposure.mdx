...
description: Retrieve daylight exposure time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/daylight_exposure/grouped"
description: "Retrieve daylight exposure timeseries data measuring time a user spent in daylight."
---
