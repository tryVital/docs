...
description: "Retrieve raw electrocardiogram (ECG) voltage samples for a specific user from a compatible wearable device."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve raw ECG voltage samples captured during an electrocardiogram reading for a user as a time series across supported wearables and devices."
---
