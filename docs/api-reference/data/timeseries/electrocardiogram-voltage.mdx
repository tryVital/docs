...
description: "Retrieve electrocardiogram (ECG) voltage timeseries data for a specific user, grouped by source across connected wearables and health providers."
