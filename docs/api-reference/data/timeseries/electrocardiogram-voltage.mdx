...
description: "Retrieve electrocardiogram voltage timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Query electrocardiogram voltage time series data for a user over a date range, grouped by provider source, with the Junction API."
---
