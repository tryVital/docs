...
description: "Retrieve electrocardiogram (ECG) voltage timeseries data for a user from their connected wearable devices and health data sources via the Junction API."
