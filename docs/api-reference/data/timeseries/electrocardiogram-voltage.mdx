...
description: "Retrieve grouped electrocardiogram voltage samples timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve electrocardiogram (ECG) voltage time-series data for a user across a date range from connected wearables."
---
