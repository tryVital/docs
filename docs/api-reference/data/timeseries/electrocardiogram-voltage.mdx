...
description: "Retrieve electrocardiogram (ECG) voltage time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve time series ECG voltage waveform samples for a Vital user across a date range."
