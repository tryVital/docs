...
description: "Retrieve time series electrocardiogram (ECG) voltage measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Query a user's electrocardiogram (ECG) voltage time series data through the Junction API, sourced from their connected wearables and health providers."
---
