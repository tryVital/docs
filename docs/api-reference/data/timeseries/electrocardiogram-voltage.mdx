...
description: "Retrieve time-series electrocardiogram voltage data for a specific user, returning raw electrocardiogram (ECG) voltage samples within a given date range."
