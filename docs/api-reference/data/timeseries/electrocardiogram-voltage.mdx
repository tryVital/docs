...
description: "Retrieve raw electrocardiogram voltage samples recorded by the device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve grouped electrocardiogram (ECG) voltage samples timeseries data for a user across a date range from the Vital API."
---
