...
description: "API endpoint to retrieve a user's electrocardiogram (ECG) voltage time series data, grouped by source, from their connected wearables and health data providers."
