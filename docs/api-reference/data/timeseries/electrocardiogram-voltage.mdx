...
description: "Retrieve electrocardiogram (ECG) voltage waveform samples for a Junction user across a date range, grouped by source provider, via the timeseries API."
