...
description: "Retrieve grouped ECG voltage time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve grouped electrocardiogram voltage time-series data for a user across a specified date range."
---
