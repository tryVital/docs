...
description: "Retrieve grouped electrocardiogram voltage time series readings for a user over a specified date range."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve raw ECG voltage time series samples for a user over a specified date range."
---
