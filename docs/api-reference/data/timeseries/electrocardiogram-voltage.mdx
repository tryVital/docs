...
description: "Reference for the Vital timeseries API endpoint that returns per-sample ECG voltage measurements for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve grouped electrocardiogram (ECG) voltage timeseries data for a user across a specified date range."
---
