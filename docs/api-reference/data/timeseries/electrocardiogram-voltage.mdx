...
description: "Retrieve a user's electrocardiogram (ECG) voltage time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve electrocardiogram voltage time series data for a specific user over a given date range, grouped by data source."
---
