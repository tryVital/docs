...
description: "Retrieve grouped timeseries data for electrocardiogram (ECG) voltage readings from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve grouped time-series electrocardiogram voltage data for a user over a specified date range."
---
