...
description: "Retrieve raw ECG voltage timeseries data for a user, recorded by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve electrocardiogram (ECG) voltage timeseries data for a user, grouped by source, over a specified date range."
---
