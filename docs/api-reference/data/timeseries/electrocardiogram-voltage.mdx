...
description: "Retrieve grouped electrocardiogram (ECG) voltage timeseries data for a user across a specified date range from connected wearables and providers."
