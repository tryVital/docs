...
description: "Retrieve grouped electrocardiogram (ECG) voltage waveform time-series data for a user across a specified date range from connected wearables."
