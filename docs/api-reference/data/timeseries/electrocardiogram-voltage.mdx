...
description: "Query a user's electrocardiogram (ECG) voltage time series data through the Vital API, sourced from their connected wearables and health providers."
---
