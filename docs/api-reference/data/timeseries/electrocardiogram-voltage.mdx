...
description: Retrieve electrocardiogram (ECG) voltage time-series readings for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/electrocardiogram_voltage/grouped"
description: "Retrieve electrocardiogram voltage timeseries samples from a user's ECG-enabled wearable device."
---
