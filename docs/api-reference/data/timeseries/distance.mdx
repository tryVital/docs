---
title: "Distance"
description: "Retrieve grouped distance traveled time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve distance travelled time series data for a user over a specified date range."
---
