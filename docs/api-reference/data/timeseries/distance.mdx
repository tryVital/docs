---
title: "Distance"
description: "Retrieve time series distance traveled measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Query a user's distance travelled time series data through the Junction API, sourced from their connected wearables and health providers."
---
