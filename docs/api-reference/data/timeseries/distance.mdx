---
title: "Distance"
description: "Retrieve distance traveled time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve time series distance traveled for a Vital user across a date range."
