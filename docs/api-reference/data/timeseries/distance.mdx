---
title: "Distance"
description: "Retrieve grouped distance covered timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve distance traveled time-series data for a user across a date range from connected wearables and fitness providers."
---
