---
title: "Distance"
description: Retrieve distance-travelled time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve distance traveled timeseries data captured from a user's connected wearable or fitness device."
---
