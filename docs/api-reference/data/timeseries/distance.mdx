---
title: "Distance"
description: "Retrieve distance travelled timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve distance traveled timeseries data for a user, grouped by source, over a specified date range."
---
