---
title: "Distance"
description: "Retrieve grouped timeseries data for distance traveled from connected wearables and fitness trackers."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve grouped time-series distance data for a user over a specified date range."
---
