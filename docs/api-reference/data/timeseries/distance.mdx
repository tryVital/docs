---
title: "Distance"
description: "Retrieve distance traveled time series data for a user, typically from walking, running, or cycling activities."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve distance traveled by the user across walking, running, and other activities for a user as a time series across supported wearables and devices."
---
