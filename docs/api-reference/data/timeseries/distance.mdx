---
title: "Distance"
description: "Retrieve distance traveled, derived from movement data for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve grouped distance traveled timeseries data for a user across a date range from the Vital API."
---
