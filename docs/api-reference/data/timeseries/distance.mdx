---
title: "Distance"
description: "Retrieve grouped distance traveled time-series data for a user across a specified date range from connected wearables and fitness trackers."
