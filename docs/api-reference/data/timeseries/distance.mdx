---
title: "Distance"
description: "Fetch grouped time-series data for distance traveled during walking, running, or activity for a Junction user, returned by source provider over a date range."
