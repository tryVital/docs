---
title: "Distance"
description: "Retrieve a user's distance time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve distance time series data for a specific user over a given date range, grouped by data source."
---
