---
title: "Distance"
description: "Reference for the Vital timeseries API endpoint that returns distance travelled for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/distance/grouped"
description: "Retrieve grouped distance traveled timeseries data for a user across a specified date range."
---
