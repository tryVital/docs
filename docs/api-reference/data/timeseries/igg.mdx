---
title: "Igg"
description: "Retrieve grouped timeseries data for immunoglobulin G (IgG) measurements from connected health devices."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve grouped time-series IgG data for a user over a specified date range."
---
