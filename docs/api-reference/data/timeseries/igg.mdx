---
title: "Igg"
description: "Retrieve grouped immunoglobulin G (IgG) time-series data for a user across connected lab and health data providers."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve grouped immunoglobulin G (IgG) time-series data for a user across a specified date range."
---
