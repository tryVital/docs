---
title: "Igg"
description: "Retrieve a user's IgG antibody time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve IgG antibody time series data for a specific user over a given date range, grouped by data source."
---
