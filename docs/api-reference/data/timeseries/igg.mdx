---
title: "Igg"
description: "Retrieve grouped Immunoglobulin G (IgG) time-series measurements for a user across a specified date range from connected health data sources."
