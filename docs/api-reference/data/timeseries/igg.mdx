---
title: "IgG"
description: "API endpoint to retrieve a user's IgG antibody time series data, grouped by source, from their connected wearables and health data providers."
