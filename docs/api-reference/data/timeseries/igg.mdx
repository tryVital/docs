---
title: "Igg"
description: "Retrieve immunoglobulin G (IgG) lab measurement time series for a specific user from connected health data sources."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve immunoglobulin G (IgG) lab measurements for the user for a user as a time series across supported wearables and devices."
---
