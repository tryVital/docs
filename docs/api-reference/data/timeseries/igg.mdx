---
title: "Igg"
description: Retrieve immunoglobulin G (IgG) time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve immunoglobulin G (IgG) timeseries data captured from a user's connected lab sources."
---
