---
title: "Igg"
description: "Reference for the Vital timeseries API endpoint that returns immunoglobulin G (IgG) antibody results for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve grouped immunoglobulin G (IgG) timeseries data for a user across a specified date range."
---
