---
title: "Igg"
description: "Retrieve Immunoglobulin G (IgG) measurements from lab results for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve grouped Immunoglobulin G (IgG) lab measurements timeseries data for a user across a date range from the Vital API."
---
