---
title: "Igg"
description: "Retrieve grouped immunoglobulin G (IgG) time series lab measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve immunoglobulin G (IgG) measurement time series data for a user over a specified date range."
---
