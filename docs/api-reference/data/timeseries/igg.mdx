---
title: "IgG"
description: "Retrieve a user's immunoglobulin G (IgG) timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve immunoglobulin G (IgG) time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
