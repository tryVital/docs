---
title: "Igg"
description: "Retrieve immunoglobulin G (IgG) lab result timeseries data for a user from their connected health records."
openapi: "GET /v2/timeseries/{user_id}/igg/grouped"
description: "Retrieve immunoglobulin G (IgG) levels timeseries data for a user, grouped by source, over a specified date range."
---
