...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time-series data for a user from the Vital API, including measurements and source metadata."
