...
description: "Retrieve forced expiratory volume in 1 second (FEV1) time series data for a user via the Junction API. Requires authentication with your team API key."
