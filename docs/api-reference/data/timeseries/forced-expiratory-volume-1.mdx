...
description: "Retrieve forced expiratory volume in one second (FEV1) time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve time series forced expiratory volume in one second (FEV1) spirometry readings for a Vital user across a date range."
