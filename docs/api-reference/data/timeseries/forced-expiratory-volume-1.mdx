...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time series data for a user across connected wearables and health data providers."
