...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time-series data for a user from their connected wearable provider over a date range."
