...
description: "Retrieve forced expiratory volume in one second (FEV1) time-series data for a user, grouped by wearable provider source over a specified date range."
