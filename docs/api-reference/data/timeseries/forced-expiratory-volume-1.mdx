...
description: "Retrieve time series forced expiratory volume in one second (FEV1) readings for a specific user across a date range from their connected wearable providers."
