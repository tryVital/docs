...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time series for a Vital user across a specified date range from the Vital API."
---
