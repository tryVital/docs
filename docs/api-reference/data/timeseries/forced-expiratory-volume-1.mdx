...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time-series data for a user from Vital's unified wearable and health data API."
