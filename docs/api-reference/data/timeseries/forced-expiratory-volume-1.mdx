...
description: "Fetch grouped time-series data for forced expiratory volume in one second (FEV1) values for a Junction user, returned by source provider over a date range."
