...
description: "Retrieve forced expiratory volume in 1 second (FEV1) timeseries data for a specific user, grouped by source across connected wearables and health providers."
