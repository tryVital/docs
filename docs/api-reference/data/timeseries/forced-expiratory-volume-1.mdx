...
description: "Retrieve time series forced expiratory volume in one second (FEV1) measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Query a user's forced expiratory volume (FEV1) time series data through the Junction API, sourced from their connected wearables and health providers."
---
