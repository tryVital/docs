...
description: "Retrieve forced expiratory volume in one second (FEV1) timeseries data for a user from connected spirometry devices."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve forced expiratory volume in 1 second (FEV1) timeseries data for a user, grouped by source, over a specified date range."
---
