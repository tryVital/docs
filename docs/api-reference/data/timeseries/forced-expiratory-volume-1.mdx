...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve forced expiratory volume in one second (FEV1) time-series data for a user from connected respiratory devices."
---
