...
description: "Fetch a user's grouped forced expiratory volume in 1 second (FEV1) time-series data from their connected wearables, health devices, and provider sources."
