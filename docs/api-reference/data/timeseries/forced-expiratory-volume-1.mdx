...
description: "Retrieve forced expiratory volume in one second (FEV1) timeseries data for a user, grouped by source provider, across the requested date range."
