...
description: "Query a user's forced expiratory volume (FEV1) time series data through the Vital API, sourced from their connected wearables and health providers."
---
