...
description: Retrieve forced expiratory volume in one second (FEV1) time-series readings for a user, grouped by source provider.
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve forced expiratory volume in one second (FEV1) timeseries data from spirometry measurements."
---
