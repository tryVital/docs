...
description: "Retrieve grouped timeseries data for forced expiratory volume in one second (FEV1) from connected devices."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve grouped time-series forced expiratory volume in one second data for a user over a specified date range."
---
