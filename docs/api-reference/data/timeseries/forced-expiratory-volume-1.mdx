...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time series data for a Vital user across their connected wearable and health data sources."
