...
description: "Retrieve grouped forced expiratory volume in 1 second (FEV1) time series data for a user, containing spirometry FEV1 readings from connected sources."
