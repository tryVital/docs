...
description: "Reference for the Vital timeseries API endpoint that returns forced expiratory volume in one second (FEV1) spirometry readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve grouped forced expiratory volume in one second (FEV1) timeseries data for a user across a specified date range."
---
