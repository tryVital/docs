...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) timeseries data for a user, including spirometry values and source provider details."
