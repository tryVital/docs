...
description: "API endpoint to retrieve a user's forced expiratory volume (FEV1) time series data, grouped by source, from their connected wearables and health data providers."
