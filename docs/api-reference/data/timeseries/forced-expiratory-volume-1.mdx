...
description: "Retrieve forced expiratory volume (FEV1) timeseries data for a user across connected providers within a specified date range using the Vital API."
