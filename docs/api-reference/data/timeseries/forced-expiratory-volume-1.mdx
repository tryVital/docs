...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time series measurements for a user by date."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve forced expiratory volume in one second (FEV1) time series data for a user."
---
