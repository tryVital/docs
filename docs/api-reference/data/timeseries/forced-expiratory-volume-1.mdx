...
description: "Retrieve forced expiratory volume in one second (FEV1) time-series data for a user over a date range, grouped by source, from Vital's Data API."
---
