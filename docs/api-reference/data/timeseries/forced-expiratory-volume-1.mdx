...
description: "Retrieve forced expiratory volume in one second (FEV1) timeseries data for a Vital user, grouped by source provider across a given date range."
