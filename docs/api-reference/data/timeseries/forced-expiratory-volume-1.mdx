...
description: "Retrieve forced expiratory volume in one second (FEV1) timeseries data for a user, grouped by source provider, between the specified start and end dates."
