...
description: "Retrieve forced expiratory volume in one second (FEV1) time-series data for a user across a specified date range from all connected providers."
