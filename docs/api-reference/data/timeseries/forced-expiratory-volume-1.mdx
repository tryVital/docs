...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) timeseries data for a user across connected wearable providers within a date range."
