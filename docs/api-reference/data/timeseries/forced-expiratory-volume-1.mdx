...
description: "Retrieve forced expiratory volume (FEV1) timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Query forced expiratory volume 1 time series data for a user over a date range, grouped by provider source, with the Junction API."
---
