...
description: "Retrieve forced expiratory volume in one second (FEV1) measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve grouped forced expiratory volume in 1 second (FEV1) timeseries data for a user across a date range from the Vital API."
---
