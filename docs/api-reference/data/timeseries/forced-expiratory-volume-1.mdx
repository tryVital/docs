...
description: "Retrieve FEV1 spirometry time series (forced expiratory volume in one second) for a specific user."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve forced expiratory volume in one second (FEV1) spirometry readings for a user as a time series across supported wearables and devices."
---
