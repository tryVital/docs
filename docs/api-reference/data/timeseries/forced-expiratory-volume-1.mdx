...
description: "Retrieve grouped forced expiratory volume in one second (FEV1) time series data for a user over a specified date range from connected wearable providers."
