...
description: "Retrieve forced expiratory volume in one second (FEV1) measurements for a Junction user across a date range, grouped by source provider, via the timeseries API."
