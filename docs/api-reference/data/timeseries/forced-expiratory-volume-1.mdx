...
description: "Retrieve a user's forced expiratory volume (FEV1) time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/forced_expiratory_volume_1/grouped"
description: "Retrieve forced expiratory volume (FEV1) time series data for a specific user over a given date range, grouped by data source."
---
