---
title: "Blood Oxygen"
description: "Retrieve time series blood oxygen saturation (SpO2) measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Query a user's blood oxygen saturation time series data through the Junction API, sourced from their connected wearables and health providers."
---
