---
title: "Blood Oxygen"
description: "Retrieve blood oxygen saturation (SpO2) time series data for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve blood oxygen saturation (SpO2) readings from wearables and devices for a user as a time series across supported wearables and devices."
---
