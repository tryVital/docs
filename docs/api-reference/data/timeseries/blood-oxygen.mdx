---
title: "Blood Oxygen"
description: "Retrieve blood oxygen saturation (SpO2) timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve blood oxygen saturation timeseries data for a user, grouped by source, over a specified date range."
---
