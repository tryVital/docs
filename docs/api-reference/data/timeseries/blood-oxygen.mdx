---
title: "Blood Oxygen"
description: "Retrieve blood oxygen saturation (SpO2) measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve grouped blood oxygen saturation (SpO2) timeseries data for a user across a date range from the Vital API."
---
