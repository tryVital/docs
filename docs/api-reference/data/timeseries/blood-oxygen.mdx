---
title: "Blood Oxygen"
description: "Retrieve grouped blood oxygen (SpO2) timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve blood oxygen saturation (SpO2) time-series data for a user across a date range from connected wearables and health providers."
---
