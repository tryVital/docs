---
title: "Blood Oxygen"
description: "Reference for the Vital timeseries API endpoint that returns blood oxygen saturation (SpO2) readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve grouped blood oxygen (SpO2) timeseries data for a user across a specified date range."
---
