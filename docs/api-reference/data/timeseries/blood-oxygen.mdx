---
title: "Blood Oxygen"
description: "Retrieve grouped blood oxygen saturation (SpO2) time series measurements for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve blood oxygen saturation (SpO2) time series data for a user over a specified date range."
---
