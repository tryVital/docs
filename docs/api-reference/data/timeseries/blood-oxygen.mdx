---
title: "Blood Oxygen"
description: "Retrieve grouped blood oxygen saturation (SpO2) time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve grouped blood oxygen saturation time-series data for a user across a specified date range."
---
