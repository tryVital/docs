---
title: "Blood Oxygen"
description: "API endpoint to retrieve a user's blood oxygen time series data, grouped by source, from their connected wearables and health data providers."
