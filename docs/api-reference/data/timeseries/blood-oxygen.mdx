---
title: "Blood Oxygen"
description: "Retrieve blood oxygen timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Query blood oxygen time series data for a user over a date range, grouped by provider source, with the Junction API."
---
