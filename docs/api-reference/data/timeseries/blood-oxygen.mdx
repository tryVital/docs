---
title: "Blood Oxygen"
description: "Retrieve grouped timeseries data for blood oxygen saturation (SpO2) levels from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve grouped time-series blood oxygen data for a user over a specified date range."
---
