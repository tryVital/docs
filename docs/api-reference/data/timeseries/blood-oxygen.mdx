---
title: "Blood Oxygen"
description: Retrieve blood oxygen saturation (SpO2) time-series readings for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve blood oxygen saturation (SpO2) timeseries data measured from a user's connected device."
---
