---
title: "Blood Oxygen"
description: "Retrieve a user's blood oxygen saturation time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/blood_oxygen/grouped"
description: "Retrieve blood oxygen time series data for a specific user over a given date range, grouped by data source."
---
