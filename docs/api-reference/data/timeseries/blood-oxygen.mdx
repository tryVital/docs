---
title: "Blood Oxygen"
description: "Retrieve blood oxygen saturation (SpO2) timeseries data for a user from their connected wearable devices and health data sources via the Junction API."
