---
title: "Blood Oxygen"
description: "Retrieve grouped blood oxygen saturation (SpO2) time series data for a user, containing peripheral oxygen saturation readings from connected sources."
