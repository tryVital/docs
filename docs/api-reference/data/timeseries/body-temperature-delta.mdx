...
description: "Retrieve deviation from baseline body temperature for a Junction user across a date range, grouped by source provider, via the timeseries API."
