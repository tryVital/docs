...
description: "Retrieve wrist temperature delta timeseries data for a user, showing nightly variation from their personal baseline."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve body temperature delta timeseries data for a user, grouped by source, over a specified date range."
---
