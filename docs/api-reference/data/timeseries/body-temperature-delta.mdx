...
description: "Retrieve grouped timeseries data for body temperature deviation from baseline from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve grouped time-series body temperature delta data for a user over a specified date range."
---
