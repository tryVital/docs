...
description: "Retrieve body temperature delta time series data for a specific user, showing deviations from their baseline, grouped by source, from their connected provider."
