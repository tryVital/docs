...
description: "Retrieve grouped body temperature delta time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve grouped body temperature deviation from baseline time-series data for a user across a specified date range."
---
