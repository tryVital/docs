...
description: "Retrieve grouped body temperature deviation from baseline timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve body temperature delta time-series data for a user across a date range from connected wearables and health providers."
---
