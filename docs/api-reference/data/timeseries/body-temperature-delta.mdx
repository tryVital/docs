...
description: "Reference for the Vital timeseries API endpoint that returns changes in body temperature from baseline for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve grouped body temperature delta timeseries data for a user across a specified date range."
---
