...
description: "Retrieve time series body temperature delta measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Query a user's body temperature delta time series data through the Junction API, sourced from their connected wearables and health providers."
---
