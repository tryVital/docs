...
description: "Retrieve deviation of body temperature from the user's baseline for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve grouped body temperature variation timeseries data for a user across a date range from the Vital API."
---
