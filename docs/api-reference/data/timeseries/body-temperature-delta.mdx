...
description: "Retrieve time series body temperature deviation from baseline readings for a specific user across a date range from their connected wearable providers."
