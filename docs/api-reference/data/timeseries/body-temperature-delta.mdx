...
description: Retrieve body temperature delta time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve body temperature delta timeseries data showing changes from a user's baseline temperature."
---
