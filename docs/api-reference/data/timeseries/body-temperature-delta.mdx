...
description: "Fetch grouped time-series data for body temperature delta readings relative to a baseline for a Junction user, returned by source provider over a date range."
