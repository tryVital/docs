...
description: "Retrieve time-series body temperature delta data for a specific user, returning body temperature deviation from the user's baseline within a given date range."
