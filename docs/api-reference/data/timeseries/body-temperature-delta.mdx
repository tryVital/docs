...
description: "Retrieve body temperature delta timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Query body temperature delta time series data for a user over a date range, grouped by provider source, with the Junction API."
---
