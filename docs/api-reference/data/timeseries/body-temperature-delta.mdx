...
description: "Retrieve body temperature delta time series for a user, showing change relative to a personal baseline."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve overnight body temperature variation relative to baseline for a user as a time series across supported wearables and devices."
---
