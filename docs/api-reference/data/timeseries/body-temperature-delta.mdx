...
description: "Retrieve grouped body temperature delta time series for a user, showing deviation from baseline as measured by wearables such as the Oura Ring."
