...
description: "Retrieve body temperature deviation time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve time series body temperature deviation from a personal baseline for a Vital user across a date range."
