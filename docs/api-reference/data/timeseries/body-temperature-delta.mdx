...
description: "Retrieve grouped body temperature delta time series data for a user, containing changes in body temperature relative to baseline from connected sources."
