...
description: "Retrieve body temperature deviation readings from a wearable, such as the Apple Watch wrist temperature for a Vital user across a date range."
