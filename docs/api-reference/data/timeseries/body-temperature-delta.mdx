...
description: "Retrieve grouped body temperature delta time series measurements for a user over a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_temperature_delta/grouped"
description: "Retrieve body temperature delta time series data, tracking changes from baseline over a specified range."
---
