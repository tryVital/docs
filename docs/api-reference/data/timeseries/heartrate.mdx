---
title: "Heart Rate"
description: "Retrieve grouped heart rate timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve heart rate time-series data for a user across a date range from connected wearables and health data providers."
---
