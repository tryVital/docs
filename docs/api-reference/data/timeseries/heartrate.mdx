---
title: "Heart Rate"
description: "Reference for the Vital timeseries API endpoint that returns heart rate readings in beats per minute for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve grouped heart rate timeseries data for a user across a specified date range."
---
