---
title: "Heart Rate"
description: "Retrieve a user's heart rate time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve heart rate time series data for a specific user over a given date range, grouped by data source."
---
