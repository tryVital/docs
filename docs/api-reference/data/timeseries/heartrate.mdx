---
title: "Heart Rate"
description: "Retrieve grouped timeseries data for heart rate measurements from connected wearables and fitness trackers."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve grouped time-series heart rate data for a user over a specified date range."
---
