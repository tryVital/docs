---
title: "Heart Rate"
description: "Retrieve grouped heart rate time-series data for a user across a specified date range from connected wearables, chest straps, and health apps."
