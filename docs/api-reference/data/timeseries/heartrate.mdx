---
title: "Heart Rate"
description: "Retrieve heart rate timeseries data for a user from their connected wearable device, in beats per minute."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve heart rate timeseries data for a user, grouped by source, over a specified date range."
---
