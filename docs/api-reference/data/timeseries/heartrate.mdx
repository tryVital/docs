---
title: "Heart Rate"
description: "Retrieve grouped heart rate time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve grouped heart rate time-series data for a user across a specified date range."
---
