---
title: "Heart Rate"
description: "Retrieve time series heart rate measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Query a user's heart rate time series data through the Junction API, sourced from their connected wearables and health providers."
---
