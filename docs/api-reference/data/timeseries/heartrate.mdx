---
title: "Heart Rate"
description: "Retrieve heart rate measurements in beats per minute for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve grouped heart rate timeseries data for a user across a date range from the Vital API."
---
