---
title: "Heart Rate"
description: "Retrieve heart rate time series data for a specific user from their connected wearable or health data provider."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve heart rate readings captured throughout the day for a user as a time series across supported wearables and devices."
---
