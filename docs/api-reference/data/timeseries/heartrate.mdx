---
title: "Heart Rate"
description: "Retrieve grouped heart rate time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve heart rate time series data for a user over a specified date range."
---
