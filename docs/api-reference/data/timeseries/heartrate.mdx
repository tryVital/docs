---
title: "Heart Rate"
description: Retrieve heart rate time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/heartrate/grouped"
description: "Retrieve heart rate timeseries data captured from a user's connected wearable or fitness device."
---
