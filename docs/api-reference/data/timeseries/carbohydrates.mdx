---
title: "Carbohydrates"
description: "Retrieve carbohydrate intake measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve grouped carbohydrate intake timeseries data for a user across a date range from the Vital API."
---
