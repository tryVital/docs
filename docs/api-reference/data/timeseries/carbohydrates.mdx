---
title: "Carbohydrates"
description: "Retrieve grouped carbohydrate intake time-series data for a user across connected nutrition and health data providers."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve grouped carbohydrate intake time-series data for a user across a specified date range."
---
