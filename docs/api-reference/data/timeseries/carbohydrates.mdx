---
title: "Carbohydrates"
description: "Retrieve grouped carbohydrate intake time-series data logged by a user across a specified date range from connected nutrition tracking apps."
