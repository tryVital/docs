---
title: "Carbohydrates"
description: "Retrieve grouped carbohydrate intake timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrate intake time-series data for a user across a date range from connected nutrition tracking providers."
---
