---
title: "Carbohydrates"
description: "Retrieve grouped timeseries data for carbohydrate intake tracking from connected health apps and devices."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve grouped time-series carbohydrates data for a user over a specified date range."
---
