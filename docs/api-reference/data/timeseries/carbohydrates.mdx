---
title: "Carbohydrates"
description: "Retrieve carbohydrate intake time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve time series carbohydrate intake amounts for a Vital user across a date range."
