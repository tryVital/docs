---
title: "Carbohydrates"
description: "Retrieve a user's carbohydrates time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrates time series data for a specific user over a given date range, grouped by data source."
---
