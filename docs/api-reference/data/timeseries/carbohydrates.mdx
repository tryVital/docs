---
title: "Carbohydrates"
description: "Retrieve grouped carbohydrate intake time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrate intake time series data for a user over a specified date range."
---
