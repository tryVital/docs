---
title: "Carbohydrates"
description: "Retrieve a user's carbohydrate intake timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrates time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
