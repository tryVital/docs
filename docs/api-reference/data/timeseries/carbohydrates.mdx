---
title: "Carbohydrates"
description: Retrieve dietary carbohydrate intake time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrate intake timeseries data logged by a user across connected nutrition sources."
---
