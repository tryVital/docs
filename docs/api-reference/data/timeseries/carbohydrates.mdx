---
title: "Carbohydrates"
description: "Retrieve carbohydrate intake time series data for a specific user from their connected nutrition tracking source."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrate intake amounts logged by the user for a user as a time series across supported wearables and devices."
---
