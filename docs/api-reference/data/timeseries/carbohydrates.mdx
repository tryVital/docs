---
title: "Carbohydrates"
description: "Retrieve carbohydrate intake timeseries data for a user, logged through their connected nutrition or health app."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve carbohydrate intake timeseries data for a user, grouped by source, over a specified date range."
---
