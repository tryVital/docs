---
title: "Carbohydrates"
description: "Reference for the Vital timeseries API endpoint that returns carbohydrate intake in grams for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Retrieve grouped carbohydrate intake timeseries data for a user across a specified date range."
---
