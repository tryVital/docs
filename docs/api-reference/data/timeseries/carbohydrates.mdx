---
title: "Carbohydrates"
description: "Retrieve time series carbohydrate intake measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/carbohydrates/grouped"
description: "Query a user's carbohydrate intake time series data through the Junction API, sourced from their connected wearables and health providers."
---
