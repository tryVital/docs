---
title: "Inhaler Usage"
description: "Retrieve inhaler usage event timeseries data for a user, logged through their connected health app or device."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve inhaler usage events timeseries data for a user, grouped by source, over a specified date range."
---
