---
title: "Inhaler Usage"
description: "Retrieve grouped timeseries data for inhaler usage events from connected health devices and trackers."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve grouped time-series inhaler usage data for a user over a specified date range."
---
