---
title: "Inhaler Usage"
description: "Retrieve grouped inhaler usage timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve inhaler usage time-series data for a user across a date range from connected respiratory devices and health providers."
---
