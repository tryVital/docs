---
title: "Inhaler Usage"
description: "Retrieve inhaler usage event time series for a specific user, tracking respiratory medication events over time."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve inhaler usage events recorded for the user for a user as a time series across supported wearables and devices."
---
