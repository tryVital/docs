---
title: "Inhaler Usage"
description: "Retrieve inhaler usage events recorded for respiratory tracking for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve grouped inhaler usage events timeseries data for a user across a date range from the Vital API."
---
