---
title: "Inhaler Usage"
description: "Retrieve grouped inhaler usage time series events recorded for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve inhaler usage event time series data for a user over a specified date range."
---
