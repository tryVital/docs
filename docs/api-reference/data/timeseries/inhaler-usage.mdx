---
title: "Inhaler Usage"
description: "Retrieve inhaler usage event time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve time series inhaler usage events for a Vital user across a date range."
