---
title: "Inhaler Usage"
description: "Retrieve a user's inhaler usage time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve inhaler usage time series data for a specific user over a given date range, grouped by data source."
---
