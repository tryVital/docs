---
title: "Inhaler Usage"
description: "Retrieve grouped inhaler usage event time-series data for a user across a specified date range from connected smart inhalers and health apps."
