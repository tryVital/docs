---
title: "Inhaler Usage"
description: Retrieve inhaler usage event time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve inhaler usage event timeseries data logged from a user's connected smart inhaler."
---
