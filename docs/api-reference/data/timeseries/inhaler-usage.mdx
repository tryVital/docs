---
title: "Inhaler Usage"
description: "Retrieve time series inhaler usage event measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Query a user's inhaler usage time series data through the Junction API, sourced from their connected wearables and health providers."
---
