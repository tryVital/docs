---
title: "Inhaler Usage"
description: "API endpoint to retrieve a user's inhaler usage time series data, grouped by source, from their connected wearables and health data providers."
