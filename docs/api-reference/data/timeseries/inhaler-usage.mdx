---
title: "Inhaler Usage"
description: "Retrieve grouped inhaler usage time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve grouped inhaler usage time-series data for a user across a specified date range."
---
