---
title: "Inhaler Usage"
description: "Reference for the Vital timeseries API endpoint that returns inhaler usage events for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/inhaler_usage/grouped"
description: "Retrieve grouped inhaler usage timeseries data for a user across a specified date range."
---
