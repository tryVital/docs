...
description: "Retrieve a user's forced vital capacity time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve forced vital capacity time series data for a specific user over a given date range, grouped by data source."
---
