...
description: "Retrieve forced vital capacity (FVC) time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve time series forced vital capacity (FVC) spirometry readings for a Vital user across a date range."
