...
description: "Retrieve grouped forced vital capacity (FVC) timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve forced vital capacity (FVC) time-series data for a user across a date range from connected respiratory devices."
---
