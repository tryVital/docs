...
description: "Retrieve forced vital capacity (FVC) timeseries data for a user from their connected spirometry device."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve forced vital capacity (FVC) timeseries data for a user, grouped by source, over a specified date range."
---
