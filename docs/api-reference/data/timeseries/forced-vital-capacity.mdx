...
description: "Retrieve grouped forced vital capacity (FVC) time-series data for a user across connected health data providers."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve grouped forced vital capacity (FVC) time-series data for a user across a specified date range."
---
