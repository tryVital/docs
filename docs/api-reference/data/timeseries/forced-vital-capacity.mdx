...
description: "Retrieve grouped forced vital capacity (FVC) timeseries data for a user across a specified date range from connected wearables and providers."
