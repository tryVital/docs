...
description: "Retrieve grouped forced vital capacity (FVC) time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve forced vital capacity (FVC) time series data for a user over a specified date range."
---
