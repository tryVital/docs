...
description: "Reference for the Vital timeseries API endpoint that returns forced vital capacity (FVC) spirometry readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve grouped forced vital capacity (FVC) timeseries data for a user across a specified date range."
---
