...
description: Retrieve forced vital capacity (FVC) spirometry time-series readings for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve forced vital capacity (FVC) timeseries data from a user's spirometry measurements."
---
