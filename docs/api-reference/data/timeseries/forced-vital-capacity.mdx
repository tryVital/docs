...
description: "Retrieve grouped timeseries data for forced vital capacity (FVC) measurements from a user's connected device."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve grouped forced vital capacity (FVC) timeseries data for a user over a specified date range."
---
