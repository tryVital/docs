...
description: "API endpoint to retrieve a user's forced vital capacity time series data, grouped by source, from their connected wearables and health data providers."
