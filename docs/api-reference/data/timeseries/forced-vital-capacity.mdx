...
description: "Retrieve forced vital capacity (FVC) spirometry time series data for a specific user from connected sources."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve forced vital capacity (FVC) spirometry readings for a user as a time series across supported wearables and devices."
---
