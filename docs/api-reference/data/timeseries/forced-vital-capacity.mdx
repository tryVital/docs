...
description: "Retrieve time series forced vital capacity (FVC) spirometry measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Query a user's forced vital capacity time series data through the Junction API, sourced from their connected wearables and health providers."
---
