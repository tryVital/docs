...
description: "Fetch grouped time-series data for forced vital capacity (FVC) measurements for a Junction user, returned by source provider over a date range."
