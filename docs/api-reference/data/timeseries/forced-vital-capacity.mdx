...
description: "Retrieve forced vital capacity (FVC) measurements from spirometry for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/forced_vital_capacity/grouped"
description: "Retrieve grouped forced vital capacity (FVC) timeseries data for a user across a date range from the Vital API."
---
