...
description: "Retrieve time-series forced vital capacity data for a specific user, returning forced vital capacity (FVC) spirometry values within a given date range."
