---
title: "Vo2 Max"
description: "Fetch grouped time-series data for VO2 max cardiorespiratory fitness measurements for a Junction user, returned by source provider over a date range."
