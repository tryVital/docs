---
title: "VO2 Max"
description: "Retrieve a user's VO2 max timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve VO2 max time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
