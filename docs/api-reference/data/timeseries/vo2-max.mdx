---
title: "Vo2 Max"
description: "Reference for the Vital timeseries API endpoint that returns estimated maximal oxygen uptake (VO2 max) for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve grouped VO2 max timeseries data for a user across a specified date range."
---
