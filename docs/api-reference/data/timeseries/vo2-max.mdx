---
title: "Vo2 Max"
description: "Retrieve VO2 max timeseries data for a user, estimating cardiorespiratory fitness from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve VO2 max timeseries data for a user, grouped by source, over a specified date range."
---
