---
title: "Vo2 Max"
description: "Retrieve grouped timeseries data for VO2 max cardiorespiratory fitness estimates from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve grouped time-series VO2 max data for a user over a specified date range."
---
