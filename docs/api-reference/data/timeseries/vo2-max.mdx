---
title: "Vo2 Max"
description: Retrieve VO2 max cardiorespiratory fitness time-series measurements for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve VO2 max timeseries data estimating a user's cardiorespiratory fitness from their wearable."
---
