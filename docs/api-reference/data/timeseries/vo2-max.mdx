---
title: "Vo2 Max"
description: "Retrieve grouped VO2 max timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve VO2 max time-series data for a user across a date range from connected wearables and fitness providers."
---
