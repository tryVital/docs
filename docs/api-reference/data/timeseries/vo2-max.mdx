---
title: "Vo2 Max"
description: "Retrieve VO2 max measurements, an estimate of cardiorespiratory fitness for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve grouped VO2 max (cardiorespiratory fitness) timeseries data for a user across a date range from the Vital API."
---
