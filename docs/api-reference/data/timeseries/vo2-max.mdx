---
title: "Vo2 Max"
description: "Retrieve time series VO2 max cardiorespiratory fitness measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Query a user's VO2 max time series data through the Junction API, sourced from their connected wearables and health providers."
---
