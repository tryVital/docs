---
title: "Vo2 Max"
description: "Retrieve VO2 max cardiorespiratory fitness time series for a specific user from a connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve cardiorespiratory fitness (VO2 max) estimates from supported wearables for a user as a time series across supported wearables and devices."
---
