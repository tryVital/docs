---
title: "Vo2 Max"
description: "Retrieve VO2 max timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Query VO2 max time series data for a user over a date range, grouped by provider source, with the Junction API."
---
