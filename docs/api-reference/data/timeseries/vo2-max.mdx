---
title: "Vo2 Max"
description: "Retrieve grouped VO2 max cardiorespiratory fitness time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve grouped VO2 max time-series data for a user across a specified date range."
---
