---
title: "Vo2 Max"
description: "Retrieve grouped VO2 max cardiorespiratory fitness time series measurements for a user by date range."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve VO2 max cardiorespiratory fitness time series data for a user over a specified date range."
---
