---
title: "Vo2 Max"
description: "Retrieve a user's VO2 max time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/vo2_max/grouped"
description: "Retrieve VO2 max time series data for a specific user over a given date range, grouped by data source."
---
