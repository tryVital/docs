...
description: "Reference for the Vital timeseries API endpoint that returns detected sleep apnea alerts for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve grouped sleep apnea alert timeseries data for a user across a specified date range."
---
