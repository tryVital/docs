...
description: "Retrieve grouped sleep apnea alert time series events recorded for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve sleep apnea alert time series events for a user over a specified date range."
---
