...
description: "Retrieve grouped sleep apnea alert event time-series data for a user across a specified date range from connected wearables such as Apple Watch."
