...
description: "Retrieve sleep apnea alert time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve time series sleep apnea alerts detected by the device for a Vital user across a date range."
