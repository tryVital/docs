...
description: "Retrieve grouped timeseries data for sleep apnea alert events from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve grouped time-series sleep apnea alert data for a user over a specified date range."
---
