...
description: "Retrieve a user's sleep apnea alert time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve sleep apnea alert time series data for a specific user over a given date range, grouped by data source."
---
