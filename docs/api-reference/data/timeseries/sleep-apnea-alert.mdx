...
description: "Retrieve sleep apnea alert events for a specific user as detected by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve sleep apnea alerts detected by the user’s wearable for a user as a time series across supported wearables and devices."
---
