...
description: "Retrieve sleep apnea alert time series data for a user, grouped by data source, from wearables and health providers connected through Junction."
