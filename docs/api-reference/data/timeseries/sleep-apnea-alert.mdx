...
description: Retrieve sleep apnea alert events as time-series data for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve sleep apnea alert events flagged by a user's connected wearable during sleep."
---
