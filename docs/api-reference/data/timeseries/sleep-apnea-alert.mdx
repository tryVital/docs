...
description: "Retrieve grouped sleep apnea alerts timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve sleep apnea alert time-series data for a user across a date range from connected wearables and health providers."
---
