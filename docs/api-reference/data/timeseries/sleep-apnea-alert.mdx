...
description: "Retrieve time series sleep apnea alert events for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Query a user's sleep apnea alert time series data through the Junction API, sourced from their connected wearables and health providers."
---
