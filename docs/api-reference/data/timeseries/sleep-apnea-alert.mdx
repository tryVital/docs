...
description: "Retrieve grouped sleep apnea alert time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve grouped sleep apnea alert time-series data for a user across a specified date range."
---
