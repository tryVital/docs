...
description: "Retrieve alerts indicating potential signs of sleep apnea for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/sleep_apnea_alert/grouped"
description: "Retrieve grouped sleep apnea alert events timeseries data for a user across a date range from the Vital API."
---
