...
description: "Retrieve time-series sleep apnea alerts data for a specific user, returning sleep apnea alerts detected on the user's device within a given date range."
