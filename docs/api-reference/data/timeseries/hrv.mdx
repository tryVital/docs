...
description: "Retrieve grouped heart rate variability (HRV) time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve grouped heart rate variability (HRV) time-series data for a user across a specified date range."
---
