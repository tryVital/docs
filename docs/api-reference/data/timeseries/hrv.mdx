...
description: "Retrieve grouped heart rate variability (HRV) timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve heart rate variability (HRV) time-series data for a user across a date range from connected wearables and providers."
---
