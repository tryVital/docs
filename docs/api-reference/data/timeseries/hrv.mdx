...
description: "Retrieve a user's heart rate variability (HRV) time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve heart rate variability time series data for a specific user over a given date range, grouped by data source."
---
