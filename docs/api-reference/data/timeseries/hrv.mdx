...
description: "Query a user's heart rate variability (HRV) time series data through the Vital API, sourced from their connected wearables and health providers."
---
