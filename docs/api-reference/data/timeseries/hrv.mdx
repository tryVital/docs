...
description: "Fetch grouped time-series data for heart rate variability (HRV) measurements for a Junction user, returned by source provider over a date range."
