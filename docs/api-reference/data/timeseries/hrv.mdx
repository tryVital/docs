...
description: "Retrieve time-series heart rate variability data for a specific user, returning heart rate variability (HRV) measurements within a given date range."
