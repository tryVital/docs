...
description: "Retrieve heart rate variability time series data for a user, grouped by data source, from wearables and health providers connected through Junction."
