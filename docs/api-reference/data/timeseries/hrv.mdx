...
description: "Retrieve grouped timeseries data for heart rate variability (HRV) from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve grouped time-series heart rate variability data for a user over a specified date range."
---
