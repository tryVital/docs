...
description: "Retrieve heart rate variability (HRV) time series data for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve heart rate variability (HRV) readings from supported wearables for a user as a time series across supported wearables and devices."
---
