...
description: "Retrieve grouped heart rate variability (HRV) timeseries data for a user across a specified date range from connected wearables and providers."
