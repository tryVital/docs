...
description: "Retrieve heart rate variability (HRV) timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve heart rate variability (HRV) timeseries data for a user, grouped by source, over a specified date range."
---
