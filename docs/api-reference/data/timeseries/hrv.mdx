...
description: "API endpoint to retrieve a user's heart rate variability (HRV) time series data, grouped by source, from their connected wearables and health data providers."
