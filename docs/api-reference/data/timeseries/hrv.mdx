...
description: "Retrieve grouped heart rate variability (HRV) time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve heart rate variability (HRV) time series data for a user over a specified date range."
---
