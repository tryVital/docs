...
description: "Retrieve time series heart rate variability (HRV) measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Query a user's heart rate variability (HRV) time series data through the Junction API, sourced from their connected wearables and health providers."
---
