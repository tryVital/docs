...
description: "Retrieve heart rate variability (HRV) timeseries data for a user across connected providers within a specified date range using the Vital API."
