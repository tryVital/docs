...
description: Retrieve heart rate variability (HRV) time-series readings for a user, grouped by source provider over a date range.
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve heart rate variability (HRV) timeseries data captured from a user's wearable device."
---
