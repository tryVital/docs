...
description: "Retrieve heart rate variability (HRV) measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve grouped heart rate variability (HRV) timeseries data for a user across a date range from the Vital API."
---
