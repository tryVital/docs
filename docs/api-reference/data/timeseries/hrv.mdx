...
description: "Reference for the Vital timeseries API endpoint that returns heart rate variability (HRV) readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/hrv/grouped"
description: "Retrieve grouped heart rate variability (HRV) timeseries data for a user across a specified date range."
---
