...
description: "Retrieve mindfulness session minutes timeseries data for a user from their connected wearable or health app."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve mindfulness minutes timeseries data for a user, grouped by source, over a specified date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-09T13:02:20.434843+00:00",
