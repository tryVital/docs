...
description: Retrieve mindfulness-minute time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve mindfulness minutes timeseries data logged from a user's connected meditation app or device."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-29T10:08:32.548444+00:00",
