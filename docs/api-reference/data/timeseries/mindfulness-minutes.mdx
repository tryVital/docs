...
description: "Retrieve grouped mindfulness minutes time series data for a user across a date range from the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-30T15:58:02.793119+00:00",
