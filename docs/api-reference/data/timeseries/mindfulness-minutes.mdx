...
description: Retrieve a user's mindfulness minutes time series data from connected wearables and health sources with the Vital API.
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-31T14:11:01.568606+00:00",
