...
description: "API reference for retrieving grouped mindfulness minutes timeseries data for a user over a specified date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-08T15:47:00.799060+00:00",
