...
description: "Retrieve grouped mindfulness minutes timeseries data for a user across a specified date range from connected wearables and providers."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-16T12:11:16.010593+00:00",
