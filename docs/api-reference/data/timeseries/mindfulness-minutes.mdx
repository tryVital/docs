...
description: "Retrieve mindfulness minutes time series data for a user, grouped by data source, from wearables and health providers connected through Junction."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-26T11:38:58.884670+00:00",
