...
description: "Retrieve mindfulness minutes time series data for a user over a specified date range, grouped by source provider."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-21T17:19:51.634030+00:00",
