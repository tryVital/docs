...
description: "Retrieve a user's mindfulness minutes time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve mindfulness minutes time series data for a specific user over a given date range, grouped by data source."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-27T16:15:21.391253+00:00",
