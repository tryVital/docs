...
description: "Retrieve mindfulness minutes timeseries data for a user across connected providers within a specified date range using the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-01T18:11:09.921832+00:00",
