...
description: "Retrieve mindfulness minutes timeseries data for a user, covering time spent in meditation or breathing sessions each window."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-15T16:27:37.630180+00:00",
