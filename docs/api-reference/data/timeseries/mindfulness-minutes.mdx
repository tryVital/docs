...
description: "Retrieve mindfulness minutes time-series data for a user, grouped by source provider, across a given date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-28T11:38:18.981371+00:00",
