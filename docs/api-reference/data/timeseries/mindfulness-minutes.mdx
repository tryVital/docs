...
description: "Retrieve grouped mindfulness minutes timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve mindfulness minutes time-series data for a user across a date range from connected wearables and wellness providers."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-27T13:22:30.080985+00:00",
