...
description: "Retrieve grouped mindfulness minutes time series data for a user over a given date range from the Vital API."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-22T14:17:26.855753+00:00",
