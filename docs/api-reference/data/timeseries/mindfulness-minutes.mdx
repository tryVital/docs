...
description: "Retrieve mindfulness minutes timeseries data for a specific user, grouped by source across connected wearables and health providers."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-22T18:37:14.963874+00:00",
