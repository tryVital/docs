...
description: "Retrieve time series mindfulness minutes measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Query a user's mindfulness minutes time series data through the Junction API, sourced from their connected wearables and health providers."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-15T10:37:00.793129+00:00",
