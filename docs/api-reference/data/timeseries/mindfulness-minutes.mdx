...
description: "Retrieve mindfulness minutes timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Query mindfulness minutes time series data for a user over a date range, grouped by provider source, with the Junction API."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-01T16:05:41.729965+00:00",
