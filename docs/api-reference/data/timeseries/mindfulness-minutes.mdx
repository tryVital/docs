...
description: "Retrieve grouped mindfulness session minutes timeseries data for a user from the Vital API over a specified date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-10T19:11:17.814412+00:00",
