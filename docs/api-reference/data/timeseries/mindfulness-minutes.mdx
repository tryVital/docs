...
description: "Retrieve a user's mindfulness minutes time series data, grouped by source, from connected providers with the Junction API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-02T18:35:08.952195+00:00",
