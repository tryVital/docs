...
description: "Retrieve mindfulness minutes timeseries samples for a user over a date range, grouped by provider and data source."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-25T12:52:07.227744+00:00",
