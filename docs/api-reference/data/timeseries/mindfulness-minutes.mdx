...
description: "Retrieve mindfulness and meditation session minutes for a specific user from their connected wearable."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve minutes the user has spent in mindfulness or meditation sessions for a user as a time series across supported wearables and devices."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-19T18:34:17.574648+00:00",
