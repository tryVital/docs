...
description: "API reference for querying a user's mindfulness minutes timeseries data, grouped by source, over a date range with the Junction API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-28T09:42:56.036822+00:00",
