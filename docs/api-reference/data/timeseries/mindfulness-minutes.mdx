...
description: "Retrieve grouped timeseries data for mindfulness and meditation minutes from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve grouped time-series mindfulness minutes data for a user over a specified date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-21T11:25:39.204696+00:00",
