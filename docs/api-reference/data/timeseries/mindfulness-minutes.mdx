...
description: "Retrieve grouped timeseries data for mindfulness session duration from a user's connected wearable provider."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-02T00:17:13.398020+00:00",
