...
description: "Retrieve mindfulness minutes timeseries data for a user via the Junction API, grouped by provider or lab source."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-25T12:02:23.033503+00:00",
