...
description: "Retrieve mindfulness minutes time series data for a user across a specified date range from connected wearables and meditation apps."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-19T11:29:17.047419+00:00",
