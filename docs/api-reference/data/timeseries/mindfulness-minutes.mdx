...
description: "Retrieve a user's mindfulness minutes time series data over a date range, grouped by data source, with the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-06T09:07:25.122959+00:00",
