...
description: "Retrieve mindfulness minutes time series data for a user via the Junction API. Requires authentication with your team API key."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-27T23:35:19.816698+00:00",
