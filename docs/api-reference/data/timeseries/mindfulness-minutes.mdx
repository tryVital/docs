...
description: "API reference for retrieving grouped mindfulness minutes timeseries data for a user from connected health devices."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-03-27T17:05:19.799937+00:00",
