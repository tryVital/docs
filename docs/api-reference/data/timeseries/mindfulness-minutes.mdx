...
description: "Retrieve mindfulness session minutes timeseries data for a user, grouped by source provider, within a specified date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-23T13:31:48.250369+00:00",
