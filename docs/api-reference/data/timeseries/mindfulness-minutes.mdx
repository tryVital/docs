...
description: "Retrieve grouped mindfulness session time series data for a user from connected wearables and meditation apps."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-14T07:37:31.195512+00:00",
