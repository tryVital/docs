...
description: "Fetch minutes spent in mindfulness sessions for a user across all connected providers within a date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-18T15:41:01.155534+00:00",
