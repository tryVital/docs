...
description: "Retrieve mindfulness minutes time-series data for a user across a specified date range from all connected providers."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-23T12:51:08.059952+00:00",
