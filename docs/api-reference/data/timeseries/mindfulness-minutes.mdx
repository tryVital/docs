...
description: "Retrieve grouped mindfulness minutes time-series data for a user from the Vital API, including measurements and source metadata."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-03T14:11:40.994962+00:00",
