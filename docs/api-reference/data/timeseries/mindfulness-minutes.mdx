...
description: "Retrieve grouped mindfulness minutes time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve grouped mindfulness minutes time-series data for a user across a specified date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-12T13:22:06.622578+00:00",
