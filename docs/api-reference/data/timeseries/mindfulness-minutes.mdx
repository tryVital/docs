...
description: "Fetch grouped mindfulness minutes time-series data for a user across a specified date range from the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-23T09:38:48.401646+00:00",
