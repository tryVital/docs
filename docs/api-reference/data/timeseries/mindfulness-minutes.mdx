...
description: "Retrieve grouped mindfulness minutes time-series data for a user across a specified date range from connected meditation apps and wearables."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-13T14:18:48.994791+00:00",
