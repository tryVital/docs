...
description: "Query a user's mindfulness minutes time series data over a date range, grouped by data source, using the Junction API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-09T09:16:10.245117+00:00",
