...
description: "Retrieve grouped mindfulness minutes time series for a Vital user across a specified date range from the Vital API."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-22T14:26:29.636172+00:00",
