...
description: "Retrieve mindfulness minutes time-series data for a user over a date range, grouped by source, from Vital's Data API."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-07T08:41:22.492526+00:00",
