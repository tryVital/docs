...
description: "Retrieve grouped timeseries data for mindfulness session duration from a user's connected wearable or health app."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve grouped mindfulness minutes timeseries data for a user over a specified date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-03-30T13:27:11.549792+00:00",
