...
description: "Retrieve mindfulness session minutes for a Junction user across a date range, grouped by source provider, via the timeseries API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-27T09:30:44.598380+00:00",
