...
description: "Retrieve mindfulness minutes timeseries data for a user via the Junction API. Requires authentication with your team API key."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-09T15:44:27.026503+00:00",
