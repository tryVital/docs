...
description: "Fetch grouped time-series data for mindfulness session minutes for a Junction user, returned by source provider over a date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-04T11:32:01.097145+00:00",
