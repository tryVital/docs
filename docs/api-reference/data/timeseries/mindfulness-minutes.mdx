...
description: "API endpoint to retrieve grouped mindfulness minutes timeseries data for a user over a specified date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-03-27T09:39:27.321649+00:00",
