...
description: "Retrieve mindfulness minutes timeseries data for a Vital user, grouped by source provider across a given date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-18T07:52:21.584089+00:00",
