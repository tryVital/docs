...
description: "Query a user's mindfulness minutes timeseries data through the Vital API, grouped by connected data source."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-03T17:56:06.519406+00:00",
