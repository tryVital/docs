...
description: "Retrieve a user's mindfulness minutes timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve mindfulness minutes time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-28T16:22:52.022760+00:00",
