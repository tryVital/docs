...
description: Retrieve a user's mindfulness minutes time series samples over a date range, grouped by the source that recorded them.
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-04T10:40:44.604063+00:00",
