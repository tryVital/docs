...
description: "Retrieve time-series mindfulness minutes data for a specific user, returning minutes the user spent on mindfulness sessions within a given date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-23T14:44:47.942033+00:00",
