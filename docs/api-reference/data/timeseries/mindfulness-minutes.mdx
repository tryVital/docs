...
description: "Retrieve mindfulness minutes timeseries data for a user, grouped by source provider, between the specified start and end dates."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-23T10:28:03.929283+00:00",
