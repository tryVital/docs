...
description: "Retrieve minutes of mindfulness or meditation activity for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve grouped mindfulness session minutes timeseries data for a user across a date range from the Vital API."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-19T12:40:49.252517+00:00",
