...
description: "Retrieve mindfulness minutes timeseries data for a specific user as recorded by their connected wearable device or app."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-29T12:23:21.356111+00:00",
