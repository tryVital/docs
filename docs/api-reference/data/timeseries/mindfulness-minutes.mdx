...
description: "Retrieve mindfulness and meditation session minutes from wearables and connected apps via the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-28T16:52:40.593908+00:00",
