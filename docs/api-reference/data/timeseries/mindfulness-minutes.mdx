...
description: "Retrieve a user's mindfulness minutes time series data grouped by source provider for a given date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-06T10:00:45.809048+00:00",
