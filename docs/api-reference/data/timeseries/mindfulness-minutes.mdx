...
description: "Retrieve mindfulness minutes timeseries data for a user from connected wearables and health apps via the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-24T14:27:11.619706+00:00",
