...
description: "Retrieve mindfulness minutes time series data recorded for a user, grouped by source, through the Junction API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-25T14:34:22.078148+00:00",
