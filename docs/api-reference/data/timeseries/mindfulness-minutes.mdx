...
description: "Retrieve minutes spent in mindfulness or meditation sessions for a specific user via the Vital timeseries API."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-09T19:40:54.661528+00:00",
