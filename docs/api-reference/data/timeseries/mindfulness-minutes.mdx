...
description: "Retrieve mindfulness minutes time series data for a specific user, grouped by data source, from their connected providers."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-08-27T16:11:40.079306+00:00",
