...
description: "Retrieve mindfulness minutes timeseries data for a user from their connected wearable devices and health data sources via the Junction API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-13T13:44:10.710676+00:00",
