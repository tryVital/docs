...
description: "Retrieve mindfulness minutes time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve time series minutes spent in mindfulness or meditation sessions for a Vital user across a date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-09-14T16:01:27.702923+00:00",
