...
description: "Retrieve timeseries mindfulness minutes grouped via the Junction API. Requires authentication with your team API key."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-03-24T17:25:45.287188+00:00",
