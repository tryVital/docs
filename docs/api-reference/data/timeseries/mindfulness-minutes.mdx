...
description: "Retrieve mindfulness minutes timeseries data for a user across a specified date range, sourced from connected meditation apps."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-05-20T18:38:08.146952+00:00",
