...
description: "Retrieve mindfulness session minutes logged through a connected app or wearable for a Vital user across a date range."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-06-11T15:26:10.279236+00:00",
