...
description: "Retrieve grouped mindfulness minutes time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve mindfulness minutes time series data for a user over a specified date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-07T20:07:35.878407+00:00",
