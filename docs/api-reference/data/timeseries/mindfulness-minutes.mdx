...
description: "Retrieve grouped mindfulness session minutes timeseries data for a specific user from their connected wearable provider."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-01T23:15:45.417425+00:00",
