...
description: "Query time-series mindfulness and meditation minutes logged from supported apps for a user via the Vital API."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-20T13:12:38.673435+00:00",
