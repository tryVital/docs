...
description: "Retrieve grouped timeseries data for mindfulness and meditation session duration from a user's connected wearable."
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-04-14T10:46:10.017353+00:00",
