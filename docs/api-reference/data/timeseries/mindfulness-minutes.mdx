...
description: "Reference for the Vital timeseries API endpoint that returns time spent in mindfulness sessions for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/mindfulness_minutes/grouped"
description: "Retrieve grouped mindfulness minutes timeseries data for a user across a specified date range."
---
    ...
    "oura": [
      {
        "data": [
          {
            "end": "2026-07-21T10:11:55.745816+00:00",
