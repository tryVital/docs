...
description: "Retrieve grouped waist circumference time-series data for a user across a specified date range from connected measuring devices and health apps."
