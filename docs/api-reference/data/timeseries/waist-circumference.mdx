...
description: "Retrieve grouped waist circumference time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve grouped waist circumference time-series data for a user across a specified date range."
---
