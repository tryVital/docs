...
description: "Retrieve grouped waist circumference time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve waist circumference time series data for a user over a specified date range."
---
