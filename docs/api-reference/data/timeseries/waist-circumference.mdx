...
description: "Retrieve waist circumference measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve grouped waist circumference timeseries data for a user across a date range from the Vital API."
---
