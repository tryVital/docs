...
description: "Retrieve time series waist circumference measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Query a user's waist circumference time series data through the Junction API, sourced from their connected wearables and health providers."
---
