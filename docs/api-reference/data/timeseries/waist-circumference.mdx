...
description: "Retrieve waist circumference time series data for a specific user from their connected health source."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve waist circumference measurements for the user for a user as a time series across supported wearables and devices."
---
