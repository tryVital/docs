...
description: "Reference for the Vital timeseries API endpoint that returns waist circumference measurements for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve grouped waist circumference timeseries data for a user across a specified date range."
---
