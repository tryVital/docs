...
description: Retrieve waist circumference time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve waist circumference timeseries data captured from a user's connected device or manual entry."
---
