...
description: "Retrieve a user's waist circumference timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve waist circumference time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
