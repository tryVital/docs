...
description: "Retrieve grouped waist circumference timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve waist circumference time-series data for a user across a date range from connected health and body measurement providers."
---
