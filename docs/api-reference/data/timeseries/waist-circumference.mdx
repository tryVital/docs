...
description: "Retrieve grouped timeseries data for waist circumference measurements from connected health devices."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve grouped time-series waist circumference data for a user over a specified date range."
---
