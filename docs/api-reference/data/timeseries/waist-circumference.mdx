...
description: "Retrieve waist circumference measurement timeseries data for a user from their connected health app or device."
openapi: "GET /v2/timeseries/{user_id}/waist_circumference/grouped"
description: "Retrieve waist circumference timeseries data for a user, grouped by source, over a specified date range."
---
