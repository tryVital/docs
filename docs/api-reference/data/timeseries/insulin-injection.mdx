...
description: "Reference for the Vital timeseries API endpoint that returns insulin injection events and dosages for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve grouped insulin injection timeseries data for a user across a specified date range."
---
