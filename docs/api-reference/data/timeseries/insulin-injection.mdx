...
description: "API endpoint to retrieve a user's insulin injection time series data, grouped by source, from their connected wearables and health data providers."
