...
description: "Retrieve grouped insulin injection event time-series data for a user across a specified date range from connected insulin pens and diabetes apps."
