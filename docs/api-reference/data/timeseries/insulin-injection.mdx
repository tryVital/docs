...
description: "Retrieve grouped timeseries data for insulin injection tracking from connected health devices and apps."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve grouped time-series insulin injection data for a user over a specified date range."
---
