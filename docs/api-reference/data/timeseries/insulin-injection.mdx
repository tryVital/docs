...
description: "Retrieve insulin injection events logged by the user for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve grouped insulin injection events timeseries data for a user across a date range from the Vital API."
---
