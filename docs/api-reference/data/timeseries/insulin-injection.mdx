...
description: "Retrieve insulin injection event time series for a specific user from their connected diabetes management source."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve insulin injection events logged by the user for a user as a time series across supported wearables and devices."
---
