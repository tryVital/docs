...
description: "Retrieve time series insulin injection event measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Query a user's insulin injection time series data through the Junction API, sourced from their connected wearables and health providers."
---
