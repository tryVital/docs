...
description: "Retrieve grouped insulin injection time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve grouped insulin injection time-series data for a user across a specified date range."
---
