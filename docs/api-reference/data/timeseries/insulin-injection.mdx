...
description: "Retrieve a user's insulin injection time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve insulin injection time series data for a specific user over a given date range, grouped by data source."
---
