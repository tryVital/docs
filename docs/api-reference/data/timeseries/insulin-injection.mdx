...
description: Retrieve insulin injection event time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve insulin injection event timeseries data logged from a user's connected diabetes device."
---
