...
description: "Retrieve grouped insulin injection time series events recorded for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve insulin injection event time series data for a user over a specified date range."
---
