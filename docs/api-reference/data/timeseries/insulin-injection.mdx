...
description: "Retrieve insulin injection event timeseries data for a user, logged through their connected health app or device."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve insulin injection events timeseries data for a user, grouped by source, over a specified date range."
---
