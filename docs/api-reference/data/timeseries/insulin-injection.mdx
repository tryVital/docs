...
description: "Retrieve grouped insulin injections timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve insulin injection time-series data for a user across a date range from connected insulin pumps and health providers."
---
