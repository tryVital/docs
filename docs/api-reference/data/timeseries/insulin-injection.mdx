...
description: "Retrieve insulin injection timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Query insulin injection time series data for a user over a date range, grouped by provider source, with the Junction API."
---
