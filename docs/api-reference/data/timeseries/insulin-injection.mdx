...
description: "Retrieve insulin injection event time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/insulin_injection/grouped"
description: "Retrieve time series insulin injection events and doses for a Vital user across a date range."
