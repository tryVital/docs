---
title: "Caffeine"
description: "Retrieve grouped caffeine intake timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine intake time-series data for a user across a date range from connected nutrition and health data providers."
---
