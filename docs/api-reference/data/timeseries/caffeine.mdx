---
title: "Caffeine"
description: "Retrieve grouped timeseries data for caffeine intake tracking from connected health apps and devices."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve grouped time-series caffeine data for a user over a specified date range."
---
