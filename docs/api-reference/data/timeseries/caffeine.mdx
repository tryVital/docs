---
title: "Caffeine"
description: "Retrieve caffeine intake time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve time series caffeine intake amounts for a Vital user across a date range."
