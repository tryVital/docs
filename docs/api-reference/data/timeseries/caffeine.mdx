---
title: "Caffeine"
description: "Retrieve caffeine intake timeseries data for a user, logged through their connected nutrition or health app."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine intake timeseries data for a user, grouped by source, over a specified date range."
---
