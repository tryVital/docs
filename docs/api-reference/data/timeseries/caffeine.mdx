---
title: "Caffeine"
description: "Retrieve time series caffeine intake measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Query a user's caffeine intake time series data through the Junction API, sourced from their connected wearables and health providers."
---
