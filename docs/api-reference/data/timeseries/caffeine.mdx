---
title: "Caffeine"
description: "Retrieve grouped caffeine intake time-series data for a user across connected nutrition and health data providers."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve grouped caffeine intake time-series data for a user across a specified date range."
---
