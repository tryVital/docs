---
title: "Caffeine"
description: "Retrieve grouped caffeine intake time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine intake time series data for a user over a specified date range."
---
