---
title: "Caffeine"
description: "Retrieve a user's caffeine intake timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
