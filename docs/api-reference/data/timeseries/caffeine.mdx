---
title: "Caffeine"
description: "Retrieve a user's caffeine time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine time series data for a specific user over a given date range, grouped by data source."
---
