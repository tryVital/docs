---
title: "Caffeine"
description: "Reference for the Vital timeseries API endpoint that returns caffeine intake in milligrams for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve grouped caffeine intake timeseries data for a user across a specified date range."
---
