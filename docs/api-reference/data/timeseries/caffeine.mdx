---
title: "Caffeine"
description: "Retrieve caffeine intake time series data for a specific user from their connected nutrition tracking source."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine intake amounts logged by the user for a user as a time series across supported wearables and devices."
---
