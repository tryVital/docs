---
title: "Caffeine"
description: "Retrieve caffeine intake measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve grouped caffeine intake timeseries data for a user across a date range from the Vital API."
---
