---
title: "Caffeine"
description: "Retrieve caffeine intake timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Query caffeine time series data for a user over a date range, grouped by provider source, with the Junction API."
---
