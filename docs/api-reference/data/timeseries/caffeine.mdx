---
title: "Caffeine"
description: Retrieve caffeine intake time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/caffeine/grouped"
description: "Retrieve caffeine intake timeseries data logged by a user across connected nutrition sources."
---
