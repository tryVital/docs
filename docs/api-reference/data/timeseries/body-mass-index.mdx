...
description: "Retrieve grouped body mass index (BMI) timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve body mass index (BMI) time-series data for a user across a date range from connected scales and health data providers."
---
