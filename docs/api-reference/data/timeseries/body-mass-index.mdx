...
description: "API endpoint to retrieve a user's body mass index (BMI) time series data, grouped by source, from their connected wearables and health data providers."
