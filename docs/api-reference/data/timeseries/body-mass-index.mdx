...
description: "Retrieve grouped body mass index (BMI) time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve grouped body mass index (BMI) time-series data for a user across a specified date range."
---
