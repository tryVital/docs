...
description: "Reference for the Vital timeseries API endpoint that returns body mass index (BMI) readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve grouped body mass index (BMI) timeseries data for a user across a specified date range."
---
