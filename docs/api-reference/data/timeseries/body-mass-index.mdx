...
description: "Retrieve time series body mass index (BMI) measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Query a user's body mass index time series data through the Junction API, sourced from their connected wearables and health providers."
---
