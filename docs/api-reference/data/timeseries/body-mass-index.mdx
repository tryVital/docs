...
description: "Retrieve a user's body mass index (BMI) time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve body mass index time series data for a specific user over a given date range, grouped by data source."
---
