...
description: Retrieve body mass index (BMI) time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve body mass index (BMI) timeseries data calculated from a user's height and weight."
---
