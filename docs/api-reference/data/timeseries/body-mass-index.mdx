...
description: "Retrieve body mass index (BMI) measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve grouped body mass index (BMI) timeseries data for a user across a date range from the Vital API."
---
