...
description: "Retrieve grouped body mass index (BMI) time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve body mass index (BMI) time series data for a user over a specified date range."
---
