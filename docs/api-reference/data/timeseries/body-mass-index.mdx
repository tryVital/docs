...
description: "Retrieve body mass index (BMI) timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Query body mass index time series data for a user over a date range, grouped by provider source, with the Junction API."
---
