...
description: "Retrieve body mass index (BMI) time series data for a specific user, calculated from weight and height measurements."
openapi: "GET /v2/timeseries/{user_id}/body_mass_index/grouped"
description: "Retrieve body mass index (BMI) values calculated from height and weight for a user as a time series across supported wearables and devices."
---
