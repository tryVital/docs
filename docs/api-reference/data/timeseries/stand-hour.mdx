---
title: "Stand Hour"
description: "Retrieve grouped stand hours timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve stand hour time-series data for a user across a date range from connected wearables and health data providers."
---
