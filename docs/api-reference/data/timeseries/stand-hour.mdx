---
title: "Stand Hour"
description: "Retrieve a user's stand hour time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve stand hour time series data for a specific user over a given date range, grouped by data source."
---
