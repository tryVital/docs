---
title: "Stand Hour"
description: "Retrieve grouped stand hour time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve grouped stand hour time-series data for a user across a specified date range."
---
