---
title: "Stand Hour"
description: "Retrieve grouped stand hour time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve stand hour time series data for a user over a specified date range."
---
