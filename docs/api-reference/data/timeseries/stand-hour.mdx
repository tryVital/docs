---
title: "Stand Hour"
description: "Retrieve a user's stand hour timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve stand hour time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
