---
title: "Stand Hour"
description: "Retrieve grouped timeseries data for stand hour goal tracking from connected wearables and fitness devices."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve grouped time-series stand hour data for a user over a specified date range."
---
