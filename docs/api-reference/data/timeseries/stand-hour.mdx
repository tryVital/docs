---
title: "Stand Hour"
description: "Retrieve stand hour time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve time series hours in which the user stood and moved for a Vital user across a date range."
