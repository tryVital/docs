---
title: "Stand Hour"
description: "Fetch grouped time-series data for stand hour records (Apple Watch-style stand goals) for a Junction user, returned by source provider over a date range."
