---
title: "Stand Hour"
description: Retrieve stand-hour time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve stand hour timeseries data flagging hours a user stood and moved during the day."
---
