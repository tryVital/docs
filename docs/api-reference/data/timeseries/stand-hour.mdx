---
title: "Stand Hour"
description: "Retrieve hours during which the user stood and moved for at least a minute for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve grouped stand hour events timeseries data for a user across a date range from the Vital API."
---
