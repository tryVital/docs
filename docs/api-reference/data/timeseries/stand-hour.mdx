---
title: "Stand Hour"
description: "Retrieve stand hour timeseries data for a user, showing hours with standing activity from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve stand hours timeseries data for a user, grouped by source, over a specified date range."
---
