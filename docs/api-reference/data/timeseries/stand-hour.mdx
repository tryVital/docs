---
title: "Stand Hour"
description: "Reference for the Vital timeseries API endpoint that returns hours in which the user stood and moved for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Retrieve grouped stand hour timeseries data for a user across a specified date range."
---
