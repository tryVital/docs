---
title: "Stand Hour"
description: "Retrieve time series stand hour measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/stand_hour/grouped"
description: "Query a user's stand hour time series data through the Junction API, sourced from their connected wearables and health providers."
---
