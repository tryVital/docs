---
title: "Stress Level"
description: "Retrieve time-series stress level data for a specific user, returning stress level readings from the user's device within a given date range."
