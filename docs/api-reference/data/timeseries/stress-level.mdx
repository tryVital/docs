---
title: "Stress Level"
description: "Retrieve stress level timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Query stress level time series data for a user over a date range, grouped by provider source, with the Junction API."
---
