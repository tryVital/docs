---
title: "Stress Level"
description: "Retrieve stress level time series measurements for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve stress level readings reported by the user’s wearable for a user as a time series across supported wearables and devices."
---
