---
title: "Stress Level"
description: "Retrieve stress level timeseries data for a user, derived from physiological signals on connected wearables."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve stress level timeseries data for a user, grouped by source, over a specified date range."
---
