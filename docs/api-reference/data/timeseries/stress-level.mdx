---
title: "Stress Level"
description: "Retrieve grouped stress level timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve stress level time-series data for a user across a date range from connected wearables and health data providers."
---
