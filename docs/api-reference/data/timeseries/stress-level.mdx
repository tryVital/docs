---
title: "Stress Level"
description: "Retrieve a user's stress level time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve stress level time series data for a specific user over a given date range, grouped by data source."
---
