---
title: "Stress Level"
description: "Reference for the Vital timeseries API endpoint that returns stress level readings from wearables for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve grouped stress level timeseries data for a user across a specified date range."
---
