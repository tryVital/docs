---
title: "Stress Level"
description: "API endpoint to retrieve a user's stress level time series data, grouped by source, from their connected wearables and health data providers."
