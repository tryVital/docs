---
title: "Stress Level"
description: "Retrieve time series stress level measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Query a user's stress level time series data through the Junction API, sourced from their connected wearables and health providers."
---
