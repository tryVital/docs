---
title: "Stress Level"
description: "Retrieve grouped stress level time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve stress level time series data for a user over a specified date range."
---
