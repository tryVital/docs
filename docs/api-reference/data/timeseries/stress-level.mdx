---
title: "Stress Level"
description: "Retrieve grouped stress level time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve grouped stress level time-series data for a user across a specified date range."
---
