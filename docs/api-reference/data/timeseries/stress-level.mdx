---
title: "Stress Level"
description: "Retrieve grouped stress level time-series data for a user across a specified date range from connected wearables such as Garmin and Fitbit."
