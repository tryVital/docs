---
title: "Stress Level"
description: Retrieve stress level time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve stress level timeseries data computed from a user's connected wearable signals."
---
