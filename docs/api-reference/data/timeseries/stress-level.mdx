---
title: "Stress Level"
description: "Retrieve stress level scores estimated by the wearable device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve grouped stress level timeseries data for a user across a date range from the Vital API."
---
