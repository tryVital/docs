---
title: "Stress Level"
description: "Retrieve grouped timeseries data for stress level measurements from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/stress_level/grouped"
description: "Retrieve grouped time-series stress level data for a user over a specified date range."
---
