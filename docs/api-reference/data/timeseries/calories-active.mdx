...
description: "Retrieve grouped active calories burned time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve active calories burned time series data for a user over a specified date range."
---
