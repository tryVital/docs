...
description: "Retrieve active calorie burn time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve time series active calories burned through movement and exercise for a Vital user across a date range."
