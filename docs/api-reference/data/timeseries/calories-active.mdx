...
description: Retrieve active calorie expenditure time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve active calories burned timeseries data from a user's connected wearable or fitness device."
---
