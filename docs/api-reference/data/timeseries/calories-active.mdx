...
description: "Retrieve grouped timeseries data for active calories burned from connected wearables and fitness trackers."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve grouped time-series active calories data for a user over a specified date range."
---
