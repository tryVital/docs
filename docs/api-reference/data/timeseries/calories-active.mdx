...
description: "Retrieve active calories burned during movement and exercise for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve grouped active calories burned timeseries data for a user across a date range from the Vital API."
---
