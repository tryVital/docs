...
description: "Fetch grouped time-series data for calories burned during active movement and exercise for a Junction user, returned by source provider over a date range."
