...
description: "Retrieve grouped timeseries data for active calories burned from a user's connected wearable."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve grouped active calories timeseries data for a user over a specified date range."
---
