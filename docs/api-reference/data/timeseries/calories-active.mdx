...
description: "Retrieve a user's calories active time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve calories active time series data for a specific user over a given date range, grouped by data source."
---
