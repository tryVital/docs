...
description: "Retrieve time series active calories burned measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Query a user's active calories burned time series data through the Junction API, sourced from their connected wearables and health providers."
---
