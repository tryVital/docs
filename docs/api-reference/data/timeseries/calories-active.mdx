...
description: "Reference for the Vital timeseries API endpoint that returns active calories burned for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve grouped active calories burned timeseries data for a user across a specified date range."
---
