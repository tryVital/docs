...
description: "Retrieve grouped active calories burned timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve active calories burned time-series data for a user across a date range from connected wearables and fitness providers."
---
