...
description: "Retrieve grouped active calories burned time-series data for a user across a specified date range from connected wearables and health apps."
