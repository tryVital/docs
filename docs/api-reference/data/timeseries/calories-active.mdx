...
description: "Retrieve grouped active calories burned time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve grouped active calories burned time-series data for a user across a specified date range."
---
