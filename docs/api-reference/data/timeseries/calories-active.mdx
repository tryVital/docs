...
description: "Retrieve active calories burned through movement and exercise for a specific user from a connected wearable."
openapi: "GET /v2/timeseries/{user_id}/calories_active/grouped"
description: "Retrieve active energy burned through movement and exercise for a user as a time series across supported wearables and devices."
---
