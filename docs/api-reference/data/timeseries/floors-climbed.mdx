...
description: "Retrieve floors climbed time series data for a specific user from their connected wearable or phone."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve number of floors climbed by the user for a user as a time series across supported wearables and devices."
---
