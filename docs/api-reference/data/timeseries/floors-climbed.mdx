...
description: "Retrieve a user's floors climbed time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve floors climbed time series data for a specific user over a given date range, grouped by data source."
---
