...
description: "Retrieve grouped floors climbed time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve floors climbed time series data for a user over a specified date range."
---
