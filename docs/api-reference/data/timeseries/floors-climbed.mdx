...
description: "Retrieve time series floors climbed measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Query a user's floors climbed time series data through the Junction API, sourced from their connected wearables and health providers."
---
