...
description: "Retrieve the number of floors climbed during the day for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve grouped floors climbed timeseries data for a user across a date range from the Vital API."
---
