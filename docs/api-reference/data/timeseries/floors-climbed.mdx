...
description: "Retrieve floors climbed timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve floors climbed timeseries data for a user, grouped by source, over a specified date range."
---
