...
description: "Retrieve grouped floors climbed timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve floors-climbed time-series data for a user across a date range from connected wearables and fitness providers."
---
