...
description: "Retrieve floors climbed time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve time series number of floors climbed for a Vital user across a date range."
