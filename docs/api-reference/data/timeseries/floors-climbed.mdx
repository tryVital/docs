...
description: "Retrieve grouped timeseries data for floors climbed from connected wearables and fitness trackers."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve grouped time-series floors climbed data for a user over a specified date range."
---
