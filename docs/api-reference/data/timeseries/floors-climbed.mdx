...
description: Retrieve floors-climbed time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve floors climbed timeseries data captured from a user's connected wearable or fitness device."
---
