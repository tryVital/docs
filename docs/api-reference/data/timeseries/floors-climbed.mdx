...
description: "Reference for the Vital timeseries API endpoint that returns number of floors climbed for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve grouped floors climbed timeseries data for a user across a specified date range."
---
