...
description: "Retrieve grouped floors climbed time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/floors_climbed/grouped"
description: "Retrieve grouped floors climbed time-series data for a user across a specified date range."
---
