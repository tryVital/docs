...
description: "Retrieve lean body mass timeseries data for a user from their connected smart scale or body composition device."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve lean body mass timeseries data for a user, grouped by source, over a specified date range."
---
