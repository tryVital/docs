...
description: "Retrieve grouped timeseries data for lean body mass measurements from connected scales and devices."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve grouped time-series lean body mass data for a user over a specified date range."
---
