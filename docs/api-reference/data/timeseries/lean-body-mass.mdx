...
description: "Retrieve lean body mass measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve grouped lean body mass timeseries data for a user across a date range from the Vital API."
---
