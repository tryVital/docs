...
description: "Retrieve lean body mass time series data for a specific user from their connected wearable or smart scale."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve lean body mass measurements for the user for a user as a time series across supported wearables and devices."
---
