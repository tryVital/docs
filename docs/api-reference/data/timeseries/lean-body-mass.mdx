...
description: "Retrieve a user's lean body mass time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve lean body mass time series data for a specific user over a given date range, grouped by data source."
---
