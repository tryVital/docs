...
description: "API endpoint to retrieve a user's lean body mass time series data, grouped by source, from their connected wearables and health data providers."
