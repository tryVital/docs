...
description: "Retrieve grouped lean body mass timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve lean body mass time-series data for a user across a date range from connected smart scales and health data providers."
---
