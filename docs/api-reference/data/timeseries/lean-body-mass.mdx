...
description: "Retrieve a user's lean body mass timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve lean body mass time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
