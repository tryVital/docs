...
description: "Retrieve grouped lean body mass time-series data for a user across a specified date range from connected smart scales and body composition tools."
