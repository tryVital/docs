...
description: "Retrieve lean body mass timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Query lean body mass time series data for a user over a date range, grouped by provider source, with the Junction API."
---
