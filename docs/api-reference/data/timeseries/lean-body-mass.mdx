...
description: "Retrieve grouped lean body mass time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve grouped lean body mass time-series data for a user across a specified date range."
---
