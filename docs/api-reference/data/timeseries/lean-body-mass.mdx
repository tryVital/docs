...
description: "Retrieve time series lean body mass measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Query a user's lean body mass time series data through the Junction API, sourced from their connected wearables and health providers."
---
