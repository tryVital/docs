...
description: "Reference for the Vital timeseries API endpoint that returns lean body mass measurements for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve grouped lean body mass timeseries data for a user across a specified date range."
---
