...
description: "Retrieve grouped lean body mass time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/lean_body_mass/grouped"
description: "Retrieve lean body mass time series data for a user over a specified date range."
---
