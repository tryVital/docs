---
title: "Glucose"
description: "Retrieve time series blood glucose measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Query a user's blood glucose time series data through the Junction API, sourced from their connected wearables and health providers."
---
