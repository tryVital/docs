---
title: "Glucose"
description: "Retrieve blood glucose time series data for a specific user from a continuous glucose monitor or other source."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve glucose readings from continuous glucose monitors and other devices for a user as a time series across supported wearables and devices."
---
