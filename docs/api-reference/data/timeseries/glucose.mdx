---
title: "Glucose"
description: "Retrieve grouped blood glucose time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve blood glucose time series data for a user over a specified date range."
---
