---
title: "Glucose"
description: "Retrieve glucose timeseries data for a user, including continuous glucose monitor (CGM) readings from connected devices."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve glucose readings timeseries data for a user, grouped by source, over a specified date range."
---
