---
title: "Glucose"
description: "Retrieve grouped timeseries data for blood glucose readings from connected CGMs and health devices."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve grouped time-series glucose data for a user over a specified date range."
---
