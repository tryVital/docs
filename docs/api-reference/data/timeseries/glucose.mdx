---
title: "Glucose"
description: "Retrieve a user's glucose time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve glucose time series data for a specific user over a given date range, grouped by data source."
---
