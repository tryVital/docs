---
title: "Glucose"
description: Retrieve blood glucose time-series readings for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve blood glucose timeseries data from a user's continuous glucose monitor or connected device."
---
