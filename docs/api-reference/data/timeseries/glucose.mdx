---
title: "Glucose"
description: "Retrieve grouped blood glucose timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve blood glucose time-series data for a user across a date range from connected CGMs and glucose monitoring devices."
---
