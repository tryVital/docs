---
title: "Glucose"
description: "Fetch grouped time-series data for glucose readings from CGMs and similar devices for a Junction user, returned by source provider over a date range."
