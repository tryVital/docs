---
title: "Glucose"
description: "Retrieve grouped blood glucose time-series data for a user across a specified date range from connected continuous glucose monitors and apps."
