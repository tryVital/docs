---
title: "Glucose"
description: "Retrieve grouped blood glucose time series data for a user over a specified date range from connected continuous glucose monitors and health apps."
