---
title: "Glucose"
description: "Retrieve a user's blood glucose timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve glucose time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
