---
title: "Glucose"
description: "Reference for the Vital timeseries API endpoint that returns blood glucose readings from CGMs and other sources for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve grouped blood glucose timeseries data for a user across a specified date range."
---
