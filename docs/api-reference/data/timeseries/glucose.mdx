---
title: "Glucose"
description: "Retrieve grouped blood glucose time-series data for a user across connected CGM, wearable, and health data providers."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve grouped blood glucose time-series data for a user across a specified date range."
---
