---
title: "Glucose"
description: "Retrieve glucose measurements from continuous glucose monitors and meters for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/glucose/grouped"
description: "Retrieve grouped blood glucose readings timeseries data for a user across a date range from the Vital API."
---
