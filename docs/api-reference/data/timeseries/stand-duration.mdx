...
description: "Retrieve stand duration timeseries data for a user, measuring time spent standing from connected wearables."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve stand duration timeseries data for a user, grouped by source, over a specified date range."
---
