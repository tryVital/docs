...
description: "Reference for the Vital timeseries API endpoint that returns time spent standing for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve grouped stand duration timeseries data for a user across a specified date range."
---
