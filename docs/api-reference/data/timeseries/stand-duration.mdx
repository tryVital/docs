...
description: "Retrieve stand duration timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Query stand duration time series data for a user over a date range, grouped by provider source, with the Junction API."
---
