...
description: "Retrieve the total time spent standing during the day for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve grouped standing duration timeseries data for a user across a date range from the Vital API."
---
