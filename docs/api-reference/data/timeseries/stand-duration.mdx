...
description: "Retrieve grouped timeseries data for standing duration tracking from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve grouped time-series stand duration data for a user over a specified date range."
---
