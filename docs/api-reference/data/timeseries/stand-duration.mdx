...
description: "Retrieve standing duration time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve time series duration spent standing for a Vital user across a date range."
