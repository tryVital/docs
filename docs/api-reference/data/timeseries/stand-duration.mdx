...
description: Retrieve standing duration time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve standing duration timeseries data captured from a user's connected wearable device."
---
