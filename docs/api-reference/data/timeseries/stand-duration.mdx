...
description: "Retrieve time series stand duration measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Query a user's stand duration time series data through the Junction API, sourced from their connected wearables and health providers."
---
