...
description: "Retrieve grouped standing duration time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve grouped stand duration time-series data for a user across a specified date range."
---
