...
description: "Retrieve grouped standing duration time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve standing duration time series data for a user over a specified date range."
---
