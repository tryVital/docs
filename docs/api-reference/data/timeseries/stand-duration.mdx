...
description: "Retrieve a user's stand duration time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve stand duration time series data for a specific user over a given date range, grouped by data source."
---
