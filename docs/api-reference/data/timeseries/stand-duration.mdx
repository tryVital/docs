...
description: "Retrieve stand duration time series data for a specific user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/stand_duration/grouped"
description: "Retrieve time the user has spent standing throughout the day for a user as a time series across supported wearables and devices."
---
