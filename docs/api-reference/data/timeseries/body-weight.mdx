---
title: "Body Weight"
description: "Retrieve a user's body weight time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve body weight time series data for a specific user over a given date range, grouped by data source."
---
