---
title: "Body Weight"
description: "Retrieve grouped body weight time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve grouped body weight time-series data for a user across a specified date range."
---
