---
title: "Body Weight"
description: "Retrieve grouped timeseries data for body weight measurements from connected scales and devices."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve grouped time-series body weight data for a user over a specified date range."
---
