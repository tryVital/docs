---
title: "Body Weight"
description: "Retrieve body weight time series data for a specific user from their connected wearable, smart scale, or health app."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve body weight measurements recorded for a user across supported wearables and devices."
---
