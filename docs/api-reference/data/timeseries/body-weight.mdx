---
title: "Body Weight"
description: Retrieve body weight time-series measurements for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve body weight timeseries data captured from a user's connected smart scale or device."
---
