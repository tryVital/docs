---
title: "Body Weight"
description: "Retrieve grouped body weight time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve body weight time series data for a user over a specified date range."
---
