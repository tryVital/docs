---
title: "Body Weight"
description: "Retrieve body weight measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve grouped body weight timeseries data for a user across a date range from the Vital API."
---
