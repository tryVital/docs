---
title: "Body Weight"
description: "Retrieve body weight timeseries data for a user from their connected smart scale or wearable device."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve body weight timeseries data for a user, grouped by source, over a specified date range."
---
