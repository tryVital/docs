---
title: "Body Weight"
description: "Retrieve time series body weight measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Query a user's body weight time series data through the Junction API, sourced from their connected wearables and health providers."
---
