---
title: "Body Weight"
description: "Retrieve body weight timeseries data for a user over a specified date range, grouped by source, using the Junction API."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Query body weight time series data for a user over a date range, grouped by provider source, with the Junction API."
---
