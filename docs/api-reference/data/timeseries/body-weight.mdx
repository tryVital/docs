---
title: "Body Weight"
description: "Retrieve grouped body weight timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve body weight time-series data for a user across a date range from connected smart scales and health data providers."
---
