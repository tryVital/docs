---
title: "Body Weight"
description: "Reference for the Vital timeseries API endpoint that returns body weight readings for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/body_weight/grouped"
description: "Retrieve grouped body weight timeseries data for a user across a specified date range."
---
