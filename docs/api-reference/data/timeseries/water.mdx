---
title: "Water"
description: "Reference for the Vital timeseries API endpoint that returns water intake in millilitres for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve grouped water intake timeseries data for a user across a specified date range."
---
