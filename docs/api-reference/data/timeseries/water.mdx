---
title: "Water"
description: "Retrieve water intake measurements for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve grouped water intake timeseries data for a user across a date range from the Vital API."
---
