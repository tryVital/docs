---
title: "Water"
description: "Retrieve grouped water intake timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve water intake time-series data for a user across a date range from connected nutrition and hydration tracking providers."
---
