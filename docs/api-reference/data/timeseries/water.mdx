---
title: "Water"
description: "Retrieve a user's water time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve water time series data for a specific user over a given date range, grouped by data source."
---
