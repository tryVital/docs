---
title: "Water"
description: Retrieve water intake time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve water intake timeseries data logged by a user across connected nutrition sources."
---
