---
title: "Water"
description: "Retrieve water intake time series data for a specific user from their connected hydration tracking source."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve water intake amounts logged by the user for a user as a time series across supported wearables and devices."
---
