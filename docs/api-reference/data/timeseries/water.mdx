---
title: "Water"
description: "Retrieve grouped timeseries data for water intake tracking from connected health apps and devices."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve grouped time-series water intake data for a user over a specified date range."
---
