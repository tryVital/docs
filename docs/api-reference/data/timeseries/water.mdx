---
title: "Water"
description: "Retrieve water intake time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve time series water intake amounts for a Vital user across a date range."
