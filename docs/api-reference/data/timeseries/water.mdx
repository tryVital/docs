---
title: "Water"
description: "Retrieve water intake timeseries data for a user, logged through their connected hydration or health app."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve water intake timeseries data for a user, grouped by source, over a specified date range."
---
