---
title: "Water"
description: "Retrieve grouped water intake time-series data logged by a user across a specified date range from connected hydration tracking apps and devices."
