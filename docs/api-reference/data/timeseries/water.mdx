---
title: "Water"
description: "Retrieve a user's water intake timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Retrieve water time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
