---
title: "Water"
description: "Retrieve time series water intake measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/water/grouped"
description: "Query a user's water intake time series data through the Junction API, sourced from their connected wearables and health providers."
---
