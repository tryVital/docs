---
title: "Steps"
description: "Reference for the Vital timeseries API endpoint that returns step counts for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve grouped step count timeseries data for a user across a specified date range."
---
