---
title: "Steps"
description: "Retrieve step count timeseries data for a user from their connected wearable device or smartphone."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve step counts timeseries data for a user, grouped by source, over a specified date range."
---
