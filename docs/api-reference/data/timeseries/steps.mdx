---
title: "Steps"
description: Retrieve step-count time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve step count timeseries data captured from a user's connected wearable or fitness device."
---
