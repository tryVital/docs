---
title: "Steps"
description: "Retrieve grouped step count time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve step count time series data for a user over a specified date range."
---
