---
title: "Steps"
description: "Retrieve grouped timeseries data for step count measurements from connected wearables and fitness trackers."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve grouped time-series step count data for a user over a specified date range."
---
