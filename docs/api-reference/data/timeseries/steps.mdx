---
title: "Steps"
description: "Retrieve step counts recorded by the wearable device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve grouped step count timeseries data for a user across a date range from the Vital API."
---
