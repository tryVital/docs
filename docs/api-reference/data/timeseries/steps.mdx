---
title: "Steps"
description: "Retrieve step count time series data for a specific user from their connected wearable, phone, or health app."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve step counts recorded by the user throughout the day for a user as a time series across supported wearables and devices."
---
