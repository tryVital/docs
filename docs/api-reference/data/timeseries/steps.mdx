---
title: "Steps"
description: "Retrieve a user's step count timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve steps time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
