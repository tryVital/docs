---
title: "Steps"
description: "Retrieve step count time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve time series step counts for a Vital user across a date range."
