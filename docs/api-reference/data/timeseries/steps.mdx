---
title: "Steps"
description: "Retrieve grouped step count time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve grouped step count time-series data for a user across a specified date range."
---
