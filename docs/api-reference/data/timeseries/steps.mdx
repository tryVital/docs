---
title: "Steps"
description: "Retrieve time series step count measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Query a user's step count time series data through the Junction API, sourced from their connected wearables and health providers."
---
