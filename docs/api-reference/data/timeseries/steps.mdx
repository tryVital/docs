---
title: "Steps"
description: "Retrieve a user's steps time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve steps time series data for a specific user over a given date range, grouped by data source."
---
