---
title: "Steps"
description: "Retrieve grouped step count timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/steps/grouped"
description: "Retrieve step count time-series data for a user across a date range from connected wearables and health data providers."
---
