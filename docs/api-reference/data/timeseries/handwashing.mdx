---
title: "Handwashing"
description: "Retrieve a user's handwashing time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve handwashing time series data for a specific user over a given date range, grouped by data source."
---
