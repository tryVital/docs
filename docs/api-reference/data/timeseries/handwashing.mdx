---
title: "Handwashing"
description: "Retrieve handwashing event time series data for a specific user as detected by their connected wearable."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve handwashing events detected by the user’s wearable for a user as a time series across supported wearables and devices."
---
