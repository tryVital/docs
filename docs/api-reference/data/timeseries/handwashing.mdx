---
title: "Handwashing"
description: "Retrieve handwashing event timeseries data for a user, recorded by their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve handwashing events timeseries data for a user, grouped by source, over a specified date range."
---
