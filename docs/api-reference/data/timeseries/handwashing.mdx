---
title: "Handwashing"
description: "Retrieve grouped handwashing event time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve grouped handwashing time-series data for a user across a specified date range."
---
