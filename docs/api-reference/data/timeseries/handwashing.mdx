---
title: "Handwashing"
description: "Retrieve grouped handwashing events timeseries data for a user over a date range from connected wearables and health providers."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve handwashing event time-series data for a user across a date range from connected wearables such as Apple Watch."
---
