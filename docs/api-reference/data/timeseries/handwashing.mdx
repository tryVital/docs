---
title: "Handwashing"
description: "Retrieve handwashing event time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve time series handwashing events and durations for a Vital user across a date range."
