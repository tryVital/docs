---
title: "Handwashing"
description: "Retrieve time series handwashing event measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Query a user's handwashing time series data through the Junction API, sourced from their connected wearables and health providers."
---
