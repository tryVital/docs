---
title: "Handwashing"
description: "Retrieve a user's handwashing event timeseries samples, grouped by source, via the Junction API."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve handwashing time series data for a user via the Junction API, with samples grouped by the provider source that recorded them."
---
