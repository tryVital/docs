---
title: "Handwashing"
description: "Retrieve time-series handwashing data for a specific user, returning handwashing events detected by the user's device within a given date range."
