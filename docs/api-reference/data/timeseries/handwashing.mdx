---
title: "Handwashing"
description: "Reference for the Vital timeseries API endpoint that returns detected handwashing events and duration for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve grouped handwashing timeseries data for a user across a specified date range."
---
