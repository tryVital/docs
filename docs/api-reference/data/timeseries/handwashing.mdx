---
title: "Handwashing"
description: Retrieve handwashing event time-series data for a user, grouped by source provider over a specified date range.
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve handwashing event timeseries data detected by a user's connected wearable device."
---
