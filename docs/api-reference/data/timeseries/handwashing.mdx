---
title: "Handwashing"
description: "Retrieve grouped timeseries data for handwashing event tracking from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve grouped time-series handwashing data for a user over a specified date range."
---
