---
title: "Handwashing"
description: "Retrieve handwashing events detected by the wearable device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/handwashing/grouped"
description: "Retrieve grouped handwashing events timeseries data for a user across a date range from the Vital API."
---
