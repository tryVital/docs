...
description: "Retrieve grouped timeseries data for wheelchair push count tracking from connected wearables and devices."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve grouped time-series wheelchair push data for a user over a specified date range."
---
