...
description: "Retrieve grouped wheelchair push time-series data for a user across connected wearable and health data providers."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve grouped wheelchair push count time-series data for a user across a specified date range."
---
