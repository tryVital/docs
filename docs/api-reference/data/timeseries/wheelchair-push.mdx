...
description: "Retrieve time series wheelchair push count measurements for a Vital user across a date range."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Query a user's wheelchair push time series data through the Junction API, sourced from their connected wearables and health providers."
---
