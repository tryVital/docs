...
description: "Retrieve time-series wheelchair pushes data for a specific user, returning the number of wheelchair pushes recorded by the user within a given date range."
