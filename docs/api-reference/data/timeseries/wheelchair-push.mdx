...
description: "Retrieve wheelchair push timeseries data for a user from their connected wearable device."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve wheelchair pushes timeseries data for a user, grouped by source, over a specified date range."
---
