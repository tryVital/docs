...
description: "Retrieve grouped wheelchair push time series measurements for a user across a specified date range."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve wheelchair push time series data for a user over a specified date range."
---
