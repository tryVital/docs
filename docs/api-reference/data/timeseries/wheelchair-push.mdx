...
description: "Retrieve wheelchair push time series data for a specific user from their connected wearable provider."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve time series wheelchair push counts for a Vital user across a date range."
