...
description: "Retrieve wheelchair push counts recorded by the device for a user as a time series from the Vital API."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve grouped wheelchair pushes timeseries data for a user across a date range from the Vital API."
---
