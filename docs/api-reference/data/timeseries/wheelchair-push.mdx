...
description: "Retrieve a user's wheelchair push time series data, grouped by data source, for a specified date range."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve wheelchair push time series data for a specific user over a given date range, grouped by data source."
---
