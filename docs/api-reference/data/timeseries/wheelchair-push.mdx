...
description: "Reference for the Vital timeseries API endpoint that returns wheelchair push counts for a user over a date range."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve grouped wheelchair push timeseries data for a user across a specified date range."
---
