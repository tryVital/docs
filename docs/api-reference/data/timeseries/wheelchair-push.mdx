...
description: "Retrieve wheelchair push count time series for a specific user with wheelchair accessibility enabled."
openapi: "GET /v2/timeseries/{user_id}/wheelchair_push/grouped"
description: "Retrieve wheelchair push counts recorded by the user for a user as a time series across supported wearables and devices."
---
