...
description: "API endpoint to retrieve a user's workout swimming stroke time series data, grouped by source, from their connected wearables and health data providers."
