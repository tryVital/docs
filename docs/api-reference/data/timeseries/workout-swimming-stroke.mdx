...
description: "Retrieve grouped swimming stroke workout time series data for a user over a specified date range from connected wearables and fitness apps."
