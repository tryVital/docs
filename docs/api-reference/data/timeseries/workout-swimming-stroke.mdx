...
description: "Retrieve time-series swimming strokes data for a specific user, returning swimming stroke counts recorded during a workout within a given date range."
