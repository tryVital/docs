...
description: "Fetch grouped time-series data for swimming stroke samples recorded during workouts for a Junction user, returned by source provider over a date range."
