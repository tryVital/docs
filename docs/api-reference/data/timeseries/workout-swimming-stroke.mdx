...
description: "Retrieve grouped swimming stroke count time-series data for a user across a specified date range from connected wearables such as Apple Watch."
