...
description: "Retrieve grouped workout swimming stroke timeseries data for a user, including stroke counts during swim workouts and source provider details."
