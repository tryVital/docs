...
description: "Retrieve time series swimming stroke samples from workouts for a specific user across a date range from their connected wearable providers."
