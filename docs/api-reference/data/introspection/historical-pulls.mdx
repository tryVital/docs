---
title: "Get historical pulls"
description: "List historical data pull records to track the progress and status of initial data backfills for connected providers."
...
Diagnose user historical data unavailability through the Historical Pull Introspection API.
