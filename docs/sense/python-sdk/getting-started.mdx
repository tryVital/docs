...
description: "Get started with the Junction Sense Python SDK for authentication, query construction, and integration with Polars and Pandas DataFrames."
---
...
Use the same [Vital API Keys](/api-details/authentication#server-to-server) your system used to interact with Junction API.
