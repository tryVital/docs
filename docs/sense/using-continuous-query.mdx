...
You can create a **Continuous Query** to have your Junction Sense [Query](/sense/overview)
...
While Continuous Query uses the same [Query DSL](/sense/query-dsl/) as the Query API, some
