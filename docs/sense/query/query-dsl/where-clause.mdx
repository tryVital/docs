...
<Note>
Column identifiers follow the Continuous Query column names. See [Column Mappings](/api-reference/horizon-ai/aggregation/query-dsl/column-expressions#column-mappings) for a full list.
</Note>
