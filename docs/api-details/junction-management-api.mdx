...
* integrate Junction Dashboard experiences into your web application with [App Embed](/app-embed/overview) — see [App Embed in the Management API Reference](/api-reference/org-management/ehr-integration/app-embed) for the endpoints involved.
