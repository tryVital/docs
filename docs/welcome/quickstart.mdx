...
| Environment        |                                             |                                 |
| ------------------ | ------------------------------------------- | ------------------------------- |
| @@FiBox sandbox    | Testing, Connect up to 10 live users        | https://api.sandbox.tryvital.io |
| @@FiZap production | Live environment to use with real customers | https://api.tryvital.io         |
...
A more detailed explanation on how linking works can be found [here](/wearables/vital-link/link_flow)
