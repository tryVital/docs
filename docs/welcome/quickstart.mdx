...
:::tip
You can use our Quickstart project with a complete backend and frontend for you to get a feeling of our API. You can find it [here](https://github.com/tryVital/quickstart). You can also try our iOS demo to explore different ways of interacting with our services. You can find the demo [here](https://github.com/tryVital/vital-ios).
:::

For our first API request, we will our sleeping endpoint. It can be accessed with a call to `/summary/sleep`:
