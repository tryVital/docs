...
If you’re using a compatible language, the easiest way is to utilize the official Svix SDKs, which handle signature verification for you.

**Option 2:** Manual Verification

If the Svix SDKs are not an option, you can manually verify them following the instructions here.