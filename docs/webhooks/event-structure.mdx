...
description: "Reference for the standard webhook event payload structure including event_type, data, team_id, user_id, and client_user_id fields."
---
...
```jsonc Wearable data event structure
{
  "data": {
...
<CodeGroup>
```jsonc Summary data event structure
{
  "data": {
...
```jsonc Example: Activity updated
{
  "data": {
...
<CodeGroup>
```jsonc Timeseries data event structure
{
  "data": {
    "data": [
      {
...
```jsonc Example: Calories Active created
{
  "data": {
    "data": [
      {
