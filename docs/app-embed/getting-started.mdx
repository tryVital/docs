...
description: "Configure App Embed and launch a Junction workflow from your partner EMR."
---

Use this guide to launch Junction from a partner EMR for the first time.
...
See [Upsert EHR Integration Configuration](/api-reference/org-management/ehr-integration/upsert-configuration) for the complete request schema.
