...
You can configure App Embed either through ["Org Config -> EHR Integration"](https://app.junction.com/org/ehr-integration) in the Junction Dashboard, or programmatically via the [Upsert App Embed Configuration](/api-reference/org-management/ehr-integration/upsert-configuration) endpoint on the Junction Management API.
