...
description: "Configure SMS and email notifications sent to patients during each status change in the on-site collection order lifecycle."
---
...
<Info>You can enable or disable SMS and Email communications individually through the [**Junction Dashboard**](http://app.junction.com/), under the Team Settings section.</Info>
