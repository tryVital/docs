...
* If you haven't done so yet, you can get API keys by signing up for a Vital account in the [Dashboard](https://app.junction.com). Detailed instructions are available [here](/home/quickstart#1-api-keys).
...
<Note>
When providing patient names in subsequent API calls, ensure they conform to our [name validation requirements](/lab/workflow/order-requirements#patient-name-validation) for security and data consistency.
</Note>
