...
description: "Test lab test ordering in the Junction sandbox environment with lifecycle simulation, pre-configured tests, and collection method restrictions."
---
...
- **Mobile Phlebotomy**: A mobile phlebotomist visits the patient's location
...
<Warning>
  When testing Mobile Phlebotomy appointments, there are only two specific ZIP codes allowed:
