...
Currently, we have closed beta support for infering the Medicare or Medicaid plan to use based on a patient's address. This endpoint supports `payor_code`s with values of `MEDFED` (Medicare) and
