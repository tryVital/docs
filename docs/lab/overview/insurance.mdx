...
description: "Learn how to place lab test orders with commercial insurance billing, including payor configuration and Medicare support."
---
...
It is expected that insurance data will become outdated or change with time. It is the customer's responsibility to update this data with Junction in order to minimise the risk of a denied claim.
