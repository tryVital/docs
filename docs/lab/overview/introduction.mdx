...
You can sign-up today to our sandbox environment. The [quickstart](/lab/overview/quickstart) guide will help you get from zero to ordering tests in less than 30 minutes! Once the integration is ready, switching to production will just be a matter of switching API keys.
