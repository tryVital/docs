...
On-site collection closely mirrors the walk-in test flow, also requiring the patient to visit a Patient Service Center. Scheduling an appointment is not necessary. On-site collections are currently in beta testing.
