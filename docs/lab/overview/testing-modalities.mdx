...
On-site collection also requires the patient to visit a Patient Service Center and closely mirrors the walk-in test flow. Scheduling an appointment is not necessary. On-site collections are currently in beta testing.
