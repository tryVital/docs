...
As it is possible to test the same biomarkers across different laboratories, there must be a way to match results across them. For this, we follow the LOINC standard.
