...
[Book PSC Appointment](/api-reference/lab-testing/psc-schedulling/appointment-psc-booking) endpoint. Requests with the same
...
manages all the logistics to retrying the booking requests with the provider.
