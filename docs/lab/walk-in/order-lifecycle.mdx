...
The events are related to a single appointment. An order can have multiple existing appointments in the Junction system, although only one appointment will be considered active
