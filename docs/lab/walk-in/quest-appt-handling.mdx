---
title: "Quest PSC Appointment Booking - Error Handling Guide"
...
| 404    | Quest-specific error messages                                               | Slot already taken or no longer exists   | Select a different time slot           |
