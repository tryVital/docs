...
| `appointment_scheduled` | _"Your appointment with the lab has been booked at {date} over at {address}!"_ <Note>This is sent only for Quest orders and Quest appointments placed through Vital API.</Note> |
| `appointment_cancelled` | _"Hey, your lab appointment at {date} for {team_name} has been cancelled."_ <Note>This is sent only for Quest orders and Quest appointments placed through Vital API.</Note> |
