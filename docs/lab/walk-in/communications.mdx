...
| `appointment_scheduled` | _"Your appointment with the lab has been booked at {date} over at {address}!"_ |
| `appointment_cancelled` | _"Hey, your lab appointment at {date} for {team_name} has been cancelled."_ |
