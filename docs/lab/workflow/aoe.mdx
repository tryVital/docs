...
description: "Handle Ask on Order Entry (AOE) questions required for certain biomarkers, including the four question types and API integration."
---
...
`required` determines whether the questions MUST be answered in order for the order to be valid. If not answered, an error will be shown: `Missing required questions - "question"`.
