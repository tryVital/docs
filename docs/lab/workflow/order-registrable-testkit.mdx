...
For guidance on self-ordering, proxy ordering, and bulk inventory workflows, see [Proxy and Inventory Workflows for Registrable Testkits](/lab/workflow/registrable-testkit-proxy-inventory-workflows).
