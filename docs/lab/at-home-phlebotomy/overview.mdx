...
- The addresses provided when fetching the appointment availability slots must be reachable by the phlebotomist, containing a street number and unit (if it exists).
