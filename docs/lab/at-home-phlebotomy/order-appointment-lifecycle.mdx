...
For each modality, there can be multiple **low-level status**, in the case of **At Home Phlebotomy**, the
...
- `appointment_cancelled`: The appointment was cancelled, by the patient, Vital or you.
...
- `cancelled`: The order was cancelled by the patient, Vital or you.
...
- `cancelled`: The appointment was cancelled by the patient, Vital or you.
