...
This is a sandbox usage limit, not a file-level validation error. Retrying the same request, creating more users, or changing the report file does not reset the limit. [Contact Junction support](/home/getting-support) if you need the limit increased for higher-volume testing or production access.
