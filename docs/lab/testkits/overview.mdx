...
This modality involves sending a kit to a patient’s home, where the patient will collect their own sample and send the kit to our Lab network thorugh mail.

Within this modality, we provide two types of testkits, those which are pre-registered to a user, and those which need to be (registerd before use)[lab/workflow/order-registrable-testkit].
...
- The patient recieves the kit, collects their sample, and sends the kit back through mail.
