...
<Accordion title="Details" defaultOpen icon="pencil" iconType="duotone">
  ...
  #### You haven't created any client lab accounts and you place a Quest order

  This order will use Junction's Quest account and Junction physicians. You don't need to specify the lab account ID or include physicians in the request.

  #### You are using a non-delegated Junction subaccount and place a Labcorp order
