...
In the [area info](/api-reference/lab-testing/area-info) endpoint, you can obtain the number of PSC's per lab in the radius of the provided zip code.

In the [PSC data](/api-reference/lab-testing/psc-info) endpoint, you can query details regarding the PSC's in the radius of the provided zip code and lab.
