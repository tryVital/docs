...
* the [Workout data events](/event-catalog/daily.data.workout.created) in the Event Catalog;
...
* the [Get Workout](/api-reference/data/workout/get-summary) endpoint documentation;
