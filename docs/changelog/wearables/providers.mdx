...
description: "Changelog of wearable provider updates including Health SDK Explicit Connect mode, sync progress logs, and provider-specific improvements."
---
...
You can now connect LibreView patients in [46 regions in the EU environment](/wearables/guides/abbott-libreview#vital-eu-region)
...
The existing hypnogram timeseries type is deprecated in favour of this new summary type.
...
* [Junction Health SDK: Automatic Data Sync](/wearables/sdks/vital-health#automatic-data-sync) for a general overview
