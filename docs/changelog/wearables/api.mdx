...
### Junction Sense Query SleepSnapshot scores (March 2026)

Junction Sense Query now supports `sleep_snapshot`, a table that returns daily sleep-derived recovery and strain insights out of the box.
...
the implicit [Data Prioritization](/sense/data-prioritization) behaviour would be disabled.
</Note>
...
Junction can use this to compute a more accurate workout Heart Rate Zones, when the provider
