---
title: "API"
description: "Changelog of Junction Wearables API updates including Sense Device Reliability, readiness scores, and Query DSL features."
---
...
- Device Reliability results are a latest snapshot that Junction refreshes daily. Each refresh updates stable provider, source type, and resource rows rather than appending historical snapshots.
