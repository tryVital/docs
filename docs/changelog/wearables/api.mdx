...
We have added the ability to **group the input rows by any Table or Source Column expression** in the Horizon AI Query DSL, applicable to both summary and timeseries resources.
