...
<Steps>
  <Step title="All Data Events (daily.data.*)" stepNumber="1" titleSize="p">
    ...
    As part of this redefinition, the `source` field is redefined to mean the _Source_ context of the `steps` timeseries
    value group. So Junction has introduced a few new _Source_ context fields:
  ...
  <Step title="Get Summary endpoints" stepNumber="2" titleSize="p">
    ...
    * Get Workouts: `GET /v2/summary/workouts/*`
    ...
    summary. So Junction has introduced a few new _Source_ context fields:
