...
<Steps>
  ...
  <Step title="Your backend API -> Your app">
    ...
    <CodeGroup>
      ...
      try {
        option.signIn(applicationContext, response.signInToken)
...
<CodeGroup>
  ...
  option.setUserId(UUID(uuidString: "ccd6f98d-3a2a-433b-a114-8fe064f301ed")!)
  ```
  ...
  option.setUserId(applicationContext, "ccd6f98d-3a2a-433b-a114-8fe064f301ed")
  ```
...
<CodeGroup>
  ...
  option.getOrCreate(applicationContext).signOut()
  ```
...
<CodeGroup>
  ...
  option.getOrCreate(applicationContext)
