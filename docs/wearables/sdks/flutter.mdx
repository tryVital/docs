...
<Tip>
  ...
  Refer to [documentation](/wearables/providers/Introduction) for all supported
  data providers.
</Tip>
...
You can do so by `VitalHealthKitClient.configure` in `application:didFinishLaunchingWithOptions`:
