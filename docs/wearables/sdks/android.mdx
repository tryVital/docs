...
And your list of permissions you need in `res/values/health_permissions.xml`:
```xml
...
It is recommended to add the following activity to your manifest to show the rationale for the health permissions:
```xml
<activity>
    ...
    <intent-filter>
