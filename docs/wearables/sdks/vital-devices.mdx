---
title: "Junction Devices SDK"
description: "Use the Junction Devices SDK for Bluetooth-based device connectivity with required permission setup for iOS and Android projects."
...
<AccordionGroup>
  ...
  You will have to request the appropriate permissions at in your app before you can call the Junction Devices SDK.
  </Accordion>
</AccordionGroup>
...
<Note>
This automatic behaviour is available since Junction iOS 1.0.0, Junction Android 3.0.0, Junction Flutter SDK 4.0.0
and Junction React Native 4.0.0.
</Note>
