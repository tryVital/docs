...
This Junction Health SDK guidance page focuses on the inital setup and API usage of the Health SDK that is common to both
...
* ❌ Fluter iOS apps (using Junction Flutter SDK 4.3.8 or later).
...
<Warning>
The health data read permission prompted is managed by the operating system. Junction cannot customize or
alter its behaviour.
</Warning>
...
Junction Health SDK schedules hourly background sync with both Apple HealthKit and Android Health Connect, provided that you have:
