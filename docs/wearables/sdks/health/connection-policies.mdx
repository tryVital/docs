---
title: "Health SDK Connection Policies"
description: "Choose between Auto Connect and Explicit Connect modes to control how the Health SDK manages Apple HealthKit and Health Connect connections."
