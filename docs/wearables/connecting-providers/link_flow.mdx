---
title: "Link Flow"
description: "Follow the step-by-step Link flow to generate tokens and initiate provider connections through the widget or custom experience."
mode: "wide"
---
...
2. You have created a Junction User that corresponds to a user in your domain. [See](/home/quickstart#3-creating-your-first-user) for an example.
</Step>
