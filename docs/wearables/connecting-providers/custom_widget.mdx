...
description: "Build a custom Link widget to match your application UI instead of using the default Junction-hosted connection experience."
---
...
You may want to have your own custom Link widget to match your app's UI. This is useful for customers who don't want to use Junction link but still want to use the Junction API. It's worthwhile ensuring that you have read the [Auth Types](/docs/auth-types) documentation before proceeding. A full code example in React Native can be seen [here](https://github.com/tryVital/vital-connect-rn).
