...
| `token_not_validated`        | The OAuth Link process has not been initiated via the [Link OAuth Provider](/api-reference/link/link-oauth-provider) endpoint. |
...
| `required_scopes_not_granted`| **ALL** required scopes have not been granted. |
