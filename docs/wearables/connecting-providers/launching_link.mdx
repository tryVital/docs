...
| ----------- | ---------- |
| Sandbox US  | `https://link.tryvital.io/?token={LINK_TOKEN}&env=sandbox&region=us` |
| Sandbox EU  | `https://link.tryvital.io/?token={LINK_TOKEN}&env=sandbox&region=eu` |
| Production US  | `https://link.tryvital.io/?token={LINK_TOKEN}&env=production&region=us` |
| Production EU  | `https://link.tryvital.io/?token={LINK_TOKEN}&env=production&region=eu` |
