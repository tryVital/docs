...
2. Generate an OAuth application credentials from your developer account. You can do this by going to the providers developer accounts page and creating a new application.
