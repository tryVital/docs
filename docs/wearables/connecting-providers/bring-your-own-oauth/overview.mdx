...
<Note>
Providers marked **Unavailable** in the **Junction default app** column of [Supported Providers](/wearables/providers/introduction#oauth-providers) require your own OAuth application. Google Health API is temporarily in this category until Junction's default application is approved.
</Note>
...
| [Google Health API](https://developers.google.com/health) | `google_health` | [↗️ Guide](/wearables/guides/google-health) |
| [Oura](https://ouraring.com)                         | `oura`            | -                                      |
| [Strava](https://www.strava.com)                     | `strava`          | [↗️ Guide](/wearables/guides/strava)   |
...
| [Garmin](https://www.garmin.com)                     | `garmin`          |
| [Google Fit](https://www.google.com/fit/)            | `google_fit`      |
| [Google Health API](https://developers.google.com/health) | `google_health` |
| [Oura](https://ouraring.com)                         | `oura`            |
