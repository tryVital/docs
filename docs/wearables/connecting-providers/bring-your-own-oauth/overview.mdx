...
description: "Use Bring Your Own OAuth (BYOO) to connect wearable providers through Junction using your own branded OAuth client credentials."
...
This provides a more cohesive experience for your users as it gives a truly white-labelled experience for your application/mobile application.
...
2. Generate OAuth application credentials from your developer account. You can do this by going to the providers developer accounts page and creating a new application.
