...
This means your OAuth application cannot simultaneously support both your own existing OAuth callback endpoint and
the [Junction Link](/wearables/connecting-providers/introduction) OAuth callback endpoint.
...
to the [Junction OAuth callback endpoint](#junction-oauth-callback-endpoint-url) and pass on _all_ the URL query parameters.
