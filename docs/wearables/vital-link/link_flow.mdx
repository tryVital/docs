...
Before initialising the link flow, ensure you have generated a `user_id` for the specific user. This should be done when a user signs up to your service and is to be stored alongside your user entry in your database. [See](/home/quickstart#3-creating-your-first-user) for more details on how to create a `user_id`.
