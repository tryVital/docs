...
| Region    | Country/Region coverage            |
| --------- | ---------------------------------- | 
| `us` \*   | United States                      |
| `ca`      | Canada                             | 
| `in`      | Singapore, Hong Kong, India, Philippines, South Korea, Taiwan |
...
| `sg`     | Singapore, Hong Kong, India, Philippines, South Korea, Taiwan | 
| `au`     | Australia                           | 
| `de`     | Germany                             | 
| `fr`     | France                              |
| `nl`     | Netherlands, Wider Europe           |
| `br`     | Brazil                              |
