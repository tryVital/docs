...
You can bind a team to a practice through either the **Dashboard** or the **API**:

- **Dashboard**: Navigate to your team's **Custom Credentials** page and set up the `Freestyle Libre` provider
  with your Practice ID.
- **API**: Use the [Team Custom Credentials API](/api-reference/org-management/upsert-team-custom-credentials)
...
You can view and delete existing bindings through the Dashboard or the [Team Custom Credentials API](/api-reference/org-management/team-custom-credentials).
