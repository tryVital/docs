...
When integrating with Junction, you have two options: use Junction's practice, or yours. We call the latter a custom practice. Depending on the approach, you need to instruct your user's to connect their Libre account to a practice.
...
Inform Junction support of the invitation, and wait for the support acknowledgement of successful practice connection.
</Step>
...
These patients do not need to connect separately to the [Junction practices](#using-vital-practices).
