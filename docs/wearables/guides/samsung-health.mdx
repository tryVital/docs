...
Refer to the [Mobile SDK Installation](/wearables/sdks/installation) and [Junction Health SDK](/wearables/sdks/vital-health) guides for SDK installation
instructions and general API usage. This guide contains information on the behaviour and required configuration
...
<Card title="Junction Health SDK" icon="heart" iconType="solid" href="/wearables/sdks/vital-health" horizontal>
...
[Junction Health SDK](/wearables/sdks/vital-health) into your Native Android or React Native mobile app.
...
Follow the [Junction Health SDK](/wearables/sdks/vital-health) guidance to
...
Before shipping Samsung Health support to production, you must have obtained for partnership approval through
...
The guidance above is a workaround to React Native internals AndroidX-incompatible handling of permission request result callbacks,
...
experience with Samsung Health, identical to Android Health Connect, similar to [Background Delivery for Apple HealthKit](/wearables/guides/apple-healthkit#background-delivery) on iOS.
...
The OS has full discretion on whether to honour or defer the time as scheduled by the Junction Health SDK. This includes the policies
