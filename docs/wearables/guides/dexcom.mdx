...
On successful connection, you will receive a [Connection create](/webhooks/introduction#connection-created-stage) webhook. [Daily webhooks](/webhooks/introduction#incremental-data-stage) `data.daily.glucose.created` and `data.daily.glucose.updated` will also be issued to your team as new or more up-to-date data becomes available during the day.
