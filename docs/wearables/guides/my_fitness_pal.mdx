...
You can now link MyFitnessPal accounts to Vital! You can do this with Junction Link Widget or programatically like other [password](/api-reference/link/link-password-provider) providers.
