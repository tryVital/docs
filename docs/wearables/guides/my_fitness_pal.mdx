...
You can now link MyFitnessPal accounts to Junction! You can do this with Junction Link Widget or programatically like other [password](/api-reference/link/link-password-provider) providers.
...
You can now use the key and your MyFitnessPal username when linking with Junction via the widget or programatically.
