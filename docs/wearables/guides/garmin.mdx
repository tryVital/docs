---
title: "Garmin"
description: "Understand Garmin webhook behavior where historical data is delivered incrementally as daily events rather than being available immediately."
---
...
Normally, when a user with an existing connection re-authenticates with the provider through [Junction Link](https://docs.tryvital.io/wearables/connecting-providers/introduction), Junction re-runs
...
To connect your device with the _widget_, follow the link wizard and enter your username and password.
