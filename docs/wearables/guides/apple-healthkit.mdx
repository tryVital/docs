...
description: "Integrate Apple HealthKit as an SDK-based provider with Junction, including sync frequency, background delivery, and Mobile SDK setup."
---
...
[configure your App Delegate](/wearables/sdks/vital-health#ios-apps-configure-your-app-delegate), 
...
<Warning>
You **MUST** [configure your App Delegate](/wearables/sdks/vital-health#ios-apps-configure-your-app-delegate) for 
