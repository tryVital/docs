...
description: "Identify the summary fields Junction calculates from related provider data, with the inputs and limitations that affect how you interpret them."
---
