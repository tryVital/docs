...
description: "Set per-user data ingestion start and end dates to control the historical pull range and automatically pause connections after expiry."
---
...
* The data ingestion bounds restrict data ingestion from any connections of the user — out-of-bound data are dropped.
...
<Note>
Because _dates_ are in floating time, you should expect an error margin of ±1 day on ingestion bound enforcement.
