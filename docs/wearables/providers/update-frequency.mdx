...
description: "Understand how Junction discovers new wearable data through push, polling, and hybrid update models across cloud-based providers."
---
...
Junction goes and fetches the notified resources, compares it against what we have already ingested, and send out the differences
...
Junction then compares the reported data against what we have already ingested, and send out the differences
(new or updated entities) to your Webhook endpoints or ETL Pipeline destinations.
</Accordion>
...
* [Junction Health SDK: Automatic Data Sync](/wearables/sdks/vital-health#automatic-data-sync)
