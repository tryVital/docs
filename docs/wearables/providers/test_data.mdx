...
- There is no limitation on the number of demo users you can create, but they do count towards the overall user limit in sandbox. Up-to-date limits can be found [on this page](/home/environments).
