...
where the number of days data backfilled varies according to the provider. [Historical backfill] (/wearables/providers/introduction#historical-days-retrieved)
