...
where the number of days of data backfilled varies according to the provider. You can find out more [here](/wearables/providers/introduction#historical-days-retrieved).
