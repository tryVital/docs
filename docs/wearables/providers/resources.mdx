...
See [Junction-Calculated Metrics](/wearables/providers/metric-sources-and-limitations) for summary fields that Junction calculates from related provider data.
