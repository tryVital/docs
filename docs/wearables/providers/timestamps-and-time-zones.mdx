...
can be specified on a per-user basis. Once specified, Junction would use the time zone to pull data and interpret timestamps from any time zone unware providers from that point onwards. 
