...
| Level                  | Remarks                                                                              |
| ---------------------- | ------------------------------------------------------------------------------------ |
| Per Data Sample        | <p>Each data sample is individually tagged with the time zone in which it was captured.</p> |
| Per User               | <p>The provider can report the time zone on a per-user basis, despite individual data samples being time zone unaware.</p><p>Vital interprets any pulled data with respect to the latest user time zone as reported by the provider.</p> |
| Fallback TZ or UTC     | <p>The provider is completely time zone unaware.</p><p>Vital uses UTC as the time zone basis to pull and tag data, unless a [Fallback Time Zone](#fallback-time-zone) is specified for the user.</p> |
...
| [Fitbit](https://www.fitbit.com/global/uk/home)                               `fitbit`               | Per User               | UTC only               |
| [Garmin](https://www.garmin.com)                                              `garmin`               | Per Data Sample        | UTC only               |
| [Google Fit](https://www.google.com/fit/)                                     `google_fit`           | Fallback TZ or UTC     | UTC only               |
...
| [Peloton](https://www.onepeloton.com)                                         `peloton`              | Per Data Sample        | UTC only               |
| [Renpho](https://renpho.com)                                                  `renpho`               | Per Data Sample        | UTC only               |
| [Strava](https://www.strava.com)                                              `strava`               | Per Data Sample        | UTC only               |
| [Wahoo](https://wahoofitness.com)                                             `wahoo`                | UTC only               | UTC only               |
| [Whoop](https://www.whoop.com)                                                `whoop`                | Per Data Sample        | UTC only               |
| [Zwift](https://zwift.com)                                                    `zwift`                | UTC only               | UTC only               |
| [Withings](https://www.withings.com)                                          `withings`             | Per Data Sample        | UTC only               |
| [iHealth](https://ihealthlabs.com)                                            `ihealth`              | Per Data Sample        | UTC only               |
| [8Sleep](https://www.eightsleep.com)                                          `eight_sleep`          | Per Data Sample        | UTC only               |
