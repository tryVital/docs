...
| [Kardia](https://kardia.com/)                        | `kardia`          | Electrocardiogram readings                                    | Vital branded OAuth, or [BYOO](/wearables/connecting-providers/bring_your_own_oauth) |
...
**Beta**: Providers under beta, these are providers that are recently added. All providers here are available in sandbox and production, any feedback you have is greatly appreciated!
