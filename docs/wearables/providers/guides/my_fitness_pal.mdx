...
<Tabs>
	...
	<Tab title="mobile">
		<Tabs>
			<Tab title="more"><img src="/img/mfp-more.jpeg" className="w-1/3 block mx-auto" /></Tab>
			<Tab title="settings"><img src="/img/mfp-settings.jpeg" className="w-1/3 block mx-auto" /></Tab>
			<Tab title="diary settings"><img src="/img/mfp-diary-settings.jpeg" className="w-1/3 block mx-auto" /></Tab>
			<Tab title="diary sharing"><img src="/img/mfp-diary-sharing.jpeg" className="w-1/3 block mx-auto" /></Tab>
		</Tabs>
	</Tab>
</Tabs>
