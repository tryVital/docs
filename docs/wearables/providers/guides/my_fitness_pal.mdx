...
<Tabs>
	...
	<Tab title="mobile">
		<Tabs>
			<Tab title="more">
				<Frame type="glass"><img src="/img/mfp-more.jpeg" className="h-90 block mx-auto" /></Frame>
			</Tab>
			<Tab title="settings">
				<Frame type="glass"><img src="/img/mfp-settings.jpeg" className="h-90 block mx-auto" /></Frame>
			</Tab>
			<Tab title="diary settings">
				<Frame type="glass"><img src="/img/mfp-diary-settings.jpeg" className="h-90 block mx-auto" /></Frame>
			</Tab>
			<Tab title="diary sharing">
				<Frame type="glass"><img src="/img/mfp-diary-sharing.jpeg" className="h-90 block mx-auto" /></Frame>
			</Tab>
		</Tabs>
	</Tab>
</Tabs>
