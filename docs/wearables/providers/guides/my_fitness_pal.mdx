...
<Tabs>
	...
	<Tab title="mobile">
		<Tabs>
			<Tab title="more">
				<Frame type="glass"><img src="/img/mfp-more.jpeg" className="w-1/2 block mx-auto" /></Frame>
			</Tab>
			<Tab title="settings">
				<Frame type="glass"><img src="/img/mfp-settings.jpeg" className="w-1/2 block mx-auto" /></Frame>
			</Tab>
			<Tab title="diary settings">
				<Frame type="glass"><img src="/img/mfp-diary-settings.jpeg" className="w-1/2 block mx-auto" /></Frame>
			</Tab>
			<Tab title="diary sharing">
				<Frame type="glass"><img src="/img/mfp-diary-sharing.jpeg" className="w-1/2 block mx-auto" /></Frame>
			</Tab>
		</Tabs>
	</Tab>
</Tabs>
...
<Frame type="glass">
  <img src="/img/mfp-link-search.png" className="w-1/2 block mx-auto" />
  <img src="/img/mfp-link-widget.png" className="w-1/2 block mx-auto" />
</Frame>
