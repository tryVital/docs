...
If you are only getting `daily.data.activity.updated`, the most likely case is that the user is neither not wearing the device, or they did not sync their device with the Fitbit app. If you are sure this is not the case, contact us through our support channels.
