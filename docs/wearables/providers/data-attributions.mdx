...
description: "Understand the Source Type taxonomy that identifies how wearable data was collected, such as from a watch, phone, ring, or companion app."
---
...
| `automatic`        | A biosensor that uploads data continuously in the background. |
