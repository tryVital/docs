---
title: "Fast Launch"
description: "Use Fast Launch URLs to reduce repeated Junction Connect launch latency when a compatible Junction session already exists."
---
...
sequenceDiagram
    ...
    participant Junction as Junction Connect
