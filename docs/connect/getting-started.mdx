...
<Steps titleSize="h3">
  <Step title="Configure your integration">
    See [Concepts -> Configuration](/connect/concepts#configuration) to set your slug, modalities, and allowed origins.
  </Step>
  ...
  <Step title="Create or resolve an integration-managed member">
    Create the member that should be signed in through Junction Connect. Include team role bindings for every team the member should access.
